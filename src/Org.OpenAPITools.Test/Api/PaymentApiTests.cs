...
namespace Org.OpenAPITools.Test
{
    ...
    public class PaymentApiTests : IDisposable
    {
        ...
        public void FinalizeSecureTransactionTest()
        {
            ...
            //AuthenticationVerificationRequest authenticationVerificationRequest = null;
            //string messageSignature = null;
            //string region = null;
            //var response = instance.FinalizeSecureTransaction(contentType, clientRequestId, apiKey, timestamp, transactionId, authenticationVerificationRequest, messageSignature, region);
