...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IAuthenticationApiSync : IApiAccessor
    {
        ...
        ApiResponse AuthenticationAccessTokensPost (string contentType, string clientRequestId, string apiKey, long timestamp, AccessTokenRequest accessTokenRequest, string messageSignature = null);
        ...
        ApiResponse AuthenticationAccessTokensPostWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, AccessTokenRequest accessTokenRequest, string messageSignature = null);
    ...
    public partial class AuthenticationApi : IAuthenticationApi
    {
        ...
        /// <param name="messageSignature">Used to ensure the request has not been tampered with during transmission. The Message-Signature is the Base64 encoded HMAC hash (SHA256 algorithm with the API Secret as the key.) For more information, refer to the supporting documentation on the Developer Portal. (optional)</param>
        /// <returns>AccessTokenResponse</returns>
        public ApiResponse AuthenticationAccessTokensPost (string contentType, string clientRequestId, string apiKey, long timestamp, AccessTokenRequest accessTokenRequest, string messageSignature = null)
        {
             ApiResponse localVarResponse = AuthenticationAccessTokensPostWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, accessTokenRequest, messageSignature);
        ...
        /// <param name="messageSignature">Used to ensure the request has not been tampered with during transmission. The Message-Signature is the Base64 encoded HMAC hash (SHA256 algorithm with the API Secret as the key.) For more information, refer to the supporting documentation on the Developer Portal. (optional)</param>
        /// <returns>ApiResponse of AccessTokenResponse</returns>
        public ApiResponse AuthenticationAccessTokensPostWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, AccessTokenRequest accessTokenRequest, string messageSignature = null)
        {
