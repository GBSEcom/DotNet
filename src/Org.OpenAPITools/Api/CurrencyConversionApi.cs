...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class CurrencyConversionApi : ICurrencyConversionApi
    {
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of ExchangeRateResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse< ExchangeRateResponse > GetExchangeRateWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, ExchangeRateRequest exchangeRateRequest, string messageSignature = default(string), string region = default(string))
        {
            ...
            var localVarResponse = this.Client.Post< ExchangeRateResponse >("/exchange-rates", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>Task of ApiResponse (ExchangeRateResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<ExchangeRateResponse>> GetExchangeRateAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, ExchangeRateRequest exchangeRateRequest, string messageSignature = default(string), string region = default(string))
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contentType' when calling CurrencyConversionApi->GetExchangeRate");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<ExchangeRateResponse>("/exchange-rates", localVarRequestOptions, this.Configuration);
