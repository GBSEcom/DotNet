...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ICurrencyConversionApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<ExchangeRateResponse>> GetExchangeRateWithHttpInfoAsync(string contentType, string clientRequestId, string apiKey, long timestamp, ExchangeRateRequest exchangeRateRequest, string messageSignature = default(string), string region = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
