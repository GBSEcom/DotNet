...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ICurrencyConversionApiSync : IApiAccessor
    {
        ...
        ExchangeRateResponse GetExchangeRate (string contentType, string clientRequestId, string apiKey, long timestamp, ExchangeRateRequest exchangeRateRequest, string messageSignature = null, string region = null);
        ...
        ApiResponse<ExchangeRateResponse> GetExchangeRateWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, ExchangeRateRequest exchangeRateRequest, string messageSignature = null, string region = null);
    ...
    public partial class CurrencyConversionApi : ICurrencyConversionApi
    {
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ExchangeRateResponse</returns>
        public ExchangeRateResponse GetExchangeRate (string contentType, string clientRequestId, string apiKey, long timestamp, ExchangeRateRequest exchangeRateRequest, string messageSignature = null, string region = null)
        {
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of ExchangeRateResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse< ExchangeRateResponse > GetExchangeRateWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, ExchangeRateRequest exchangeRateRequest, string messageSignature = null, string region = null)
        {
            ...
            var response = this.Client.Post< ExchangeRateResponse >("/exchange-rates", requestOptions, this.Configuration);
