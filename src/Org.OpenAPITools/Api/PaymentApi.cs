...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IPaymentApiSync : IApiAccessor
    {
        ...
        ApiResponse FinalizeSecureTransaction (string contentType, string clientRequestId, string apiKey, long timestamp, string transactionId, AuthenticationUpdateRequest authenticationUpdateRequest, string messageSignature = null, string region = null);
        ...
        ApiResponse FinalizeSecureTransactionWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string transactionId, AuthenticationUpdateRequest authenticationUpdateRequest, string messageSignature = null, string region = null);
        /// <summary>
    ...
    public partial class PaymentApi : IPaymentApi
    {
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>TransactionResponse</returns>
        public ApiResponse FinalizeSecureTransaction (string contentType, string clientRequestId, string apiKey, long timestamp, string transactionId, AuthenticationUpdateRequest authenticationUpdateRequest, string messageSignature = null, string region = null)
        {
            ApiResponse localVarResponse = FinalizeSecureTransactionWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, transactionId, authenticationUpdateRequest, messageSignature, region);
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of TransactionResponse</returns>
        public ApiResponse FinalizeSecureTransactionWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string transactionId, AuthenticationUpdateRequest authenticationUpdateRequest, string messageSignature = null, string region = null)
        {
