...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class PaymentSchedulesApi : IPaymentSchedulesApi
    {
        ...
        /// <param name="storeId">An optional outlet ID for clients that support multiple stores in the same developer app. (optional)</param>
        /// <returns>Task of ApiResponse (PaymentSchedulesResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<PaymentSchedulesResponse>> CancelPaymentScheduleAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, string messageSignature = default(string), string region = default(string), string storeId = default(string))
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contentType' when calling PaymentSchedulesApi->CancelPaymentSchedule");
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<PaymentSchedulesResponse>("/payment-schedules/{order-id}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<PaymentSchedulesResponse>> CreatePaymentScheduleAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, PaymentSchedulesRequest paymentSchedulesRequest, string messageSignature = default(string), string region = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<PaymentSchedulesResponse>("/payment-schedules", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<RecurringPaymentDetailsResponse>> InquiryPaymentScheduleAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, string messageSignature = default(string), string region = default(string), string storeId = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<RecurringPaymentDetailsResponse>("/payment-schedules/{order-id}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<PaymentSchedulesResponse>> UpdatePaymentScheduleAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, PaymentSchedulesRequest paymentSchedulesRequest, string messageSignature = default(string), string region = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PatchAsync<PaymentSchedulesResponse>("/payment-schedules/{order-id}", localVarRequestOptions, this.Configuration);
