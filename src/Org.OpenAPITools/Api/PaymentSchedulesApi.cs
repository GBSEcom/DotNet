...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IPaymentSchedulesApiSync : IApiAccessor
    {
        ...
        ApiResponse CancelPaymentSchedule (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, string messageSignature = null, string region = null, string storeId = null);
        ...
        ApiResponse CancelPaymentScheduleWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, string messageSignature = null, string region = null, string storeId = null);
        /// <summary>
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>PaymentSchedulesResponse</returns>
        ApiResponse CreatePaymentSchedule (string contentType, string clientRequestId, string apiKey, long timestamp, PaymentSchedulesRequest paymentSchedulesRequest, string messageSignature = null, string region = null);
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of PaymentSchedulesResponse</returns>
        ApiResponse CreatePaymentScheduleWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, PaymentSchedulesRequest paymentSchedulesRequest, string messageSignature = null, string region = null);
        /// <summary>
        ...
        ApiResponse InquiryPaymentSchedule (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, string messageSignature = null, string region = null, string storeId = null);
        ...
        ApiResponse InquiryPaymentScheduleWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, string messageSignature = null, string region = null, string storeId = null);
        /// <summary>
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>PaymentSchedulesResponse</returns>
        ApiResponse UpdatePaymentSchedule (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, PaymentSchedulesRequest paymentSchedulesRequest, string messageSignature = null, string region = null);
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of PaymentSchedulesResponse</returns>
        ApiResponse UpdatePaymentScheduleWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, PaymentSchedulesRequest paymentSchedulesRequest, string messageSignature = null, string region = null);
    ...
    public partial class PaymentSchedulesApi : IPaymentSchedulesApi
    {
        ...
        /// <param name="storeId">An optional outlet ID for clients that support multiple stores in the same developer app. (optional)</param>
        /// <returns>PaymentSchedulesResponse</returns>
        public ApiResponse CancelPaymentSchedule (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, string messageSignature = null, string region = null, string storeId = null)
        {
            ApiResponse localVarResponse = CancelPaymentScheduleWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, orderId, messageSignature, region, storeId);
        ...
        /// <param name="storeId">An optional outlet ID for clients that support multiple stores in the same developer app. (optional)</param>
        /// <returns>ApiResponse of PaymentSchedulesResponse</returns>
        public ApiResponse CancelPaymentScheduleWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, string messageSignature = null, string region = null, string storeId = null)
        {
            ...
            IRestResponse response = this.Client.Delete("/payment-schedules/{order-id}", requestOptions);
            ...
            {
                case 200:
                    return new ApiResponse(statusCode, (PaymentSchedulesResponse)this.Client.Deserialize(response, typeof(PaymentSchedulesResponse)), response.Headers);
                default:
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>PaymentSchedulesResponse</returns>
        public ApiResponse CreatePaymentSchedule (string contentType, string clientRequestId, string apiKey, long timestamp, PaymentSchedulesRequest paymentSchedulesRequest, string messageSignature = null, string region = null)
        {
            ApiResponse localVarResponse = CreatePaymentScheduleWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, paymentSchedulesRequest, messageSignature, region);
             return localVarResponse;
        }
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of PaymentSchedulesResponse</returns>
        public ApiResponse CreatePaymentScheduleWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, PaymentSchedulesRequest paymentSchedulesRequest, string messageSignature = null, string region = null)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
            ...
            IRestResponse response = this.Client.Post("/payment-schedules", requestOptions);
            ...
            switch (statusCode)
            {
                case 200:
                    return new ApiResponse(statusCode, (PaymentSchedulesResponse)this.Client.Deserialize(response, typeof(PaymentSchedulesResponse)), response.Headers);
                case 409:
                    return new ApiResponse(statusCode, (PaymentSchedulesErrorResponse)this.Client.Deserialize(response, typeof(PaymentSchedulesErrorResponse)), response.Headers);
                case 422:
                    return new ApiResponse(statusCode, (PaymentSchedulesErrorResponse)this.Client.Deserialize(response, typeof(PaymentSchedulesErrorResponse)), response.Headers);
                default:
                    return new ApiResponse(statusCode, (ErrorResponse)this.Client.Deserialize(response, typeof(ErrorResponse)), response.Headers);
        ...
        /// <param name="storeId">An optional outlet ID for clients that support multiple stores in the same developer app. (optional)</param>
        /// <returns>RecurringPaymentDetailsResponse</returns>
        public ApiResponse InquiryPaymentSchedule (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, string messageSignature = null, string region = null, string storeId = null)
        {
            ApiResponse localVarResponse = InquiryPaymentScheduleWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, orderId, messageSignature, region, storeId);
             return localVarResponse;
        }
        ...
        /// <param name="storeId">An optional outlet ID for clients that support multiple stores in the same developer app. (optional)</param>
        /// <returns>ApiResponse of RecurringPaymentDetailsResponse</returns>
        public ApiResponse InquiryPaymentScheduleWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, string messageSignature = null, string region = null, string storeId = null)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
            ...
            IRestResponse response = this.Client.Get("/payment-schedules/{order-id}", requestOptions);
            ...
            {
                case 200:
                    return new ApiResponse(statusCode, (RecurringPaymentDetailsResponse)this.Client.Deserialize(response, typeof(RecurringPaymentDetailsResponse)), response.Headers);
                default:
                    return new ApiResponse(statusCode, (ErrorResponse)this.Client.Deserialize(response, typeof(ErrorResponse)), response.Headers);
            }
        }
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>PaymentSchedulesResponse</returns>
        public ApiResponse UpdatePaymentSchedule (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, PaymentSchedulesRequest paymentSchedulesRequest, string messageSignature = null, string region = null)
        {
            ApiResponse localVarResponse = UpdatePaymentScheduleWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, orderId, paymentSchedulesRequest, messageSignature, region);
             return localVarResponse;
        }
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of PaymentSchedulesResponse</returns>
        public ApiResponse UpdatePaymentScheduleWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string orderId, PaymentSchedulesRequest paymentSchedulesRequest, string messageSignature = null, string region = null)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
            ...
            IRestResponse response = this.Client.Patch("/payment-schedules/{order-id}", requestOptions);
