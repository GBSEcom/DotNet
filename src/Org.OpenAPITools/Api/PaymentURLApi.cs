...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class PaymentURLApi : IPaymentURLApi
    {
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>Task of ApiResponse (PaymentUrlResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<PaymentUrlResponse>> CreatePaymentUrlAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, PaymentUrlRequest paymentUrlRequest, string messageSignature = default(string), string region = default(string))
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contentType' when calling PaymentURLApi->CreatePaymentUrl");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<PaymentUrlResponse>("/payment-url", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<PaymentUrlResponse>> DeletePaymentUrlAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string messageSignature = default(string), string region = default(string), string storeId = default(string), string transactionId = default(string), string orderId = default(string), string paymentUrlId = default(string), string transactionTime = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<PaymentUrlResponse>("/payment-url", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<PaymentUrlDetailResponse>> PaymentUrlDetailAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, string fromDate, string toDate, string messageSignature = default(string), string region = default(string), string storeId = default(string), string orderId = default(string), string merchantTransactionId = default(string), string status = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PaymentUrlDetailResponse>("/payment-url", localVarRequestOptions, this.Configuration);
