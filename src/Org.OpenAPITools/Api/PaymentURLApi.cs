...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IPaymentURLApiSync : IApiAccessor
    {
        ...
        ApiResponse CreatePaymentUrl(string contentType, string clientRequestId, string apiKey, long timestamp, PaymentUrlRequest paymentUrlRequest, string messageSignature = null, string region = null);
        ...
        ApiResponse CreatePaymentUrlWithHttpInfo(string contentType, string clientRequestId, string apiKey, long timestamp, PaymentUrlRequest paymentUrlRequest, string messageSignature = null, string region = null);
        /// <summary>
        ...
        /// <param name="transactionId">Gateway transaction identifier as returned in the parameter ipgTransactionId. (optional)</param>
        ...
        /// <returns>PaymentUrlResponse</returns>
        ApiResponse DeletePaymentUrl(string contentType, string clientRequestId, string apiKey, long timestamp, string messageSignature = null, string region = null, string storeId = null, string transactionId = null, string orderId = null, string paymentUrlId = null, string transactionTime = null);
        ...
        /// <param name="transactionTime">The transaction time in seconds since epoch. (optional)</param>
        /// <returns>ApiResponse of PaymentUrlResponse</returns>
        ApiResponse DeletePaymentUrlWithHttpInfo(string contentType, string clientRequestId, string apiKey, long timestamp, string messageSignature = null, string region = null, string storeId = null, string transactionId = null, string orderId = null, string paymentUrlId = null, string transactionTime = null);
        /// <summary>
        ...
        ApiResponse PaymentUrlDetail(string contentType, string clientRequestId, string apiKey, long timestamp, string fromDate, string toDate, string messageSignature = null, string region = null, string storeId = null, string orderId = null, string merchantTransactionId = null, string status = null);
        ...
        ApiResponse PaymentUrlDetailWithHttpInfo(string contentType, string clientRequestId, string apiKey, long timestamp, string fromDate, string toDate, string messageSignature = null, string region = null, string storeId = null, string orderId = null, string merchantTransactionId = null, string status = null);
    ...
    public partial class PaymentURLApi : IPaymentURLApi
    {
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>PaymentUrlResponse</returns>
        public ApiResponse CreatePaymentUrl(string contentType, string clientRequestId, string apiKey, long timestamp, PaymentUrlRequest paymentUrlRequest, string messageSignature = null, string region = null)
        {
            ApiResponse localVarResponse = CreatePaymentUrlWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, paymentUrlRequest, messageSignature, region);
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of PaymentUrlResponse</returns>
        public ApiResponse CreatePaymentUrlWithHttpInfo(string contentType, string clientRequestId, string apiKey, long timestamp, PaymentUrlRequest paymentUrlRequest, string messageSignature = null, string region = null)
        {
            ...
            IRestResponse response = this.Client.Post("/payment-url", requestOptions);
            ...
            {
                case 200:
                    return new ApiResponse(statusCode, (PaymentUrlResponse)this.Client.Deserialize(response, typeof(PaymentUrlResponse)), response.Headers);
                default:
        ...
        /// <param name="transactionTime">The transaction time in seconds since epoch. (optional)</param>
        /// <returns>PaymentUrlResponse</returns>
        public ApiResponse DeletePaymentUrl(string contentType, string clientRequestId, string apiKey, long timestamp, string messageSignature = null, string region = null, string storeId = null, string transactionId = null, string orderId = null, string paymentUrlId = null, string transactionTime = null)
        {
            ApiResponse localVarResponse = DeletePaymentUrlWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, messageSignature, region, storeId, transactionId, orderId, paymentUrlId, transactionTime);
            return localVarResponse;
        }
        ...
        /// <param name="transactionTime">The transaction time in seconds since epoch. (optional)</param>
        /// <returns>ApiResponse of PaymentUrlResponse</returns>
        public ApiResponse DeletePaymentUrlWithHttpInfo(string contentType, string clientRequestId, string apiKey, long timestamp, string messageSignature = null, string region = null, string storeId = null, string transactionId = null, string orderId = null, string paymentUrlId = null, string transactionTime = null)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
            ...
            IRestResponse response = this.Client.Delete("/payment-url", requestOptions);
        ...
        /// <param name="status">The status of payment URL. (optional)</param>
        /// <returns>PaymentUrlDetailResponse</returns>
        public ApiResponse PaymentUrlDetail(string contentType, string clientRequestId, string apiKey, long timestamp, string fromDate, string toDate, string messageSignature = null, string region = null, string storeId = null, string orderId = null, string merchantTransactionId = null, string status = null)
        {
            ApiResponse localVarResponse = PaymentUrlDetailWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, fromDate, toDate, messageSignature, region, storeId, orderId, merchantTransactionId, status);
            return localVarResponse;
        }
        ...
        /// <param name="status">The status of payment URL. (optional)</param>
        /// <returns>ApiResponse of PaymentUrlDetailResponse</returns>
        public ApiResponse PaymentUrlDetailWithHttpInfo(string contentType, string clientRequestId, string apiKey, long timestamp, string fromDate, string toDate, string messageSignature = null, string region = null, string storeId = null, string orderId = null, string merchantTransactionId = null, string status = null)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
            ...
            IRestResponse response = this.Client.Get("/payment-url", requestOptions);
            ...
            {
                case 200:
                    return new ApiResponse(statusCode, (PaymentUrlDetailResponse)this.Client.Deserialize(response, typeof(PaymentUrlDetailResponse)), response.Headers);
                default:
                    return new ApiResponse(statusCode, (ErrorResponse)this.Client.Deserialize(response, typeof(ErrorResponse)), response.Headers);
            }
        }
