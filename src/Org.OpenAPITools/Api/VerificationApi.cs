...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IVerificationApiSync : IApiAccessor
    {
        ...
        TransactionResponse VerifyAccount (string contentType, string clientRequestId, string apiKey, long timestamp, AccountVerificationRequest accountVerificationRequest, string messageSignature = null, string region = null);
        ...
        ApiResponse<TransactionResponse> VerifyAccountWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, AccountVerificationRequest accountVerificationRequest, string messageSignature = null, string region = null);
        /// <summary>
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>TransactionResponse</returns>
        TransactionResponse VerifyCard (string contentType, string clientRequestId, string apiKey, long timestamp, CardVerificationRequest cardVerificationRequest, string messageSignature = null, string region = null);
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of TransactionResponse</returns>
        ApiResponse<TransactionResponse> VerifyCardWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, CardVerificationRequest cardVerificationRequest, string messageSignature = null, string region = null);
    ...
    public interface IVerificationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TransactionResponse> VerifyAccountAsync (string contentType, string clientRequestId, string apiKey, long timestamp, AccountVerificationRequest accountVerificationRequest, string messageSignature = null, string region = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<TransactionResponse>> VerifyAccountAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, AccountVerificationRequest accountVerificationRequest, string messageSignature = null, string region = null);
        /// <summary>
        /// Verify a payment card.
        /// </summary>
        /// <remarks>
    ...
    public partial class VerificationApi : IVerificationApi
    {
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>TransactionResponse</returns>
        public TransactionResponse VerifyAccount (string contentType, string clientRequestId, string apiKey, long timestamp, AccountVerificationRequest accountVerificationRequest, string messageSignature = null, string region = null)
        {
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of TransactionResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse< TransactionResponse > VerifyAccountWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, AccountVerificationRequest accountVerificationRequest, string messageSignature = null, string region = null)
        {
            ...
            if (timestamp == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'timestamp' when calling VerificationApi->VerifyAccount");
            ...
            requestOptions.Data = accountVerificationRequest;


            // make the HTTP request

            var response = this.Client.Post< TransactionResponse >("/account-verification", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("VerifyAccount", response);
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>Task of TransactionResponse</returns>
        public async System.Threading.Tasks.Task<TransactionResponse> VerifyAccountAsync (string contentType, string clientRequestId, string apiKey, long timestamp, AccountVerificationRequest accountVerificationRequest, string messageSignature = null, string region = null)
        {
             Org.OpenAPITools.Client.ApiResponse<TransactionResponse> localVarResponse = await VerifyAccountAsyncWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, accountVerificationRequest, messageSignature, region);
             return localVarResponse.Data;
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>Task of ApiResponse (TransactionResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<TransactionResponse>> VerifyAccountAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, AccountVerificationRequest accountVerificationRequest, string messageSignature = null, string region = null)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contentType' when calling VerificationApi->VerifyAccount");
            ...
            var response = await this.AsynchronousClient.PostAsync<TransactionResponse>("/account-verification", requestOptions, this.Configuration);
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>TransactionResponse</returns>
        public TransactionResponse VerifyCard (string contentType, string clientRequestId, string apiKey, long timestamp, CardVerificationRequest cardVerificationRequest, string messageSignature = null, string region = null)
        {
        ...
        /// <param name="region">Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)</param>
        /// <returns>ApiResponse of TransactionResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse< TransactionResponse > VerifyCardWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, CardVerificationRequest cardVerificationRequest, string messageSignature = null, string region = null)
        {
            // verify the required parameter 'contentType' is set
            if (contentType == null)
            ...
            // verify the required parameter 'timestamp' is set
            if (timestamp == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'timestamp' when calling VerificationApi->VerifyCard");
            ...
            var response = this.Client.Post< TransactionResponse >("/card-verification", requestOptions, this.Configuration);
