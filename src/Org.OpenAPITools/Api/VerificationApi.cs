...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class VerificationApi : IVerificationApi
    {
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<TransactionResponse>> VerifyAccountAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, AccountVerificationRequest accountVerificationRequest, string messageSignature = default(string), string region = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<TransactionResponse>("/account-verification", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<TransactionResponse>> VerifyCardAsyncWithHttpInfo (string contentType, string clientRequestId, string apiKey, long timestamp, CardVerificationRequest cardVerificationRequest, string messageSignature = default(string), string region = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<TransactionResponse>("/card-verification", localVarRequestOptions, this.Configuration);
