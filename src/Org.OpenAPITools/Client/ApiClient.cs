...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        private async Task<IRestResponse> SendRequest(RestRequest req)
        {
        ...
        public async Task<IRestResponse> GetAsync(string path, RequestOptions options, IReadableConfiguration configuration = null)
        {
            var config = configuration ?? GlobalConfiguration.Instance;
            return await SendRequest(newRequest(HttpMethod.Get, path, options, config));
        }
        ...
        public async Task<IRestResponse> PostAsync(string path, RequestOptions options, IReadableConfiguration configuration = null)
        {
            var config = configuration ?? GlobalConfiguration.Instance;
            return await SendRequest(newRequest(HttpMethod.Post, path, options, config));
        }
        ...
        public async Task<IRestResponse> PutAsync(string path, RequestOptions options, IReadableConfiguration configuration = null)
        {
            var config = configuration ?? GlobalConfiguration.Instance;
            return await SendRequest(newRequest(HttpMethod.Put, path, options, config));
        }
        ...
        public async Task<IRestResponse> DeleteAsync(string path, RequestOptions options, IReadableConfiguration configuration = null)
        {
            var config = configuration ?? GlobalConfiguration.Instance;
            return await SendRequest(newRequest(HttpMethod.Delete, path, options, config));
        }
        ...
        public async Task<IRestResponse> PatchAsync(string path, RequestOptions options, IReadableConfiguration configuration = null)
        {
            var config = configuration ?? GlobalConfiguration.Instance;
            return await SendRequest(newRequest(HttpMethod.Patch, path, options, config));
        }
        ...
        public IRestResponse Get(string path, RequestOptions options)
        {
        ...
        public IRestResponse Post(string path, RequestOptions options)
        {
            return PostAsync(path, options).Result;
        }
        ...
        public IRestResponse Put(string path, RequestOptions options)
        {
            return PutAsync(path, options).Result;
        }
        ...
        public IRestResponse Delete(string path, RequestOptions options)
        {
            return DeleteAsync(path, options).Result;
        }
        ...
        public IRestResponse Patch(string path, RequestOptions options)
        {
            return PatchAsync(path, options).Result;
        }
        #endregion ISynchronousClient

        public object Deserialize(IRestResponse response, Type type, IReadableConfiguration configuration = null)
        {
            var codec = new CustomJsonCodec(configuration);
            object res = codec.Deserialize(response, type);
            return res;
        }
    }
}
