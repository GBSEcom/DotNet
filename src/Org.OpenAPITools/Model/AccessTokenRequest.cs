...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AccessTokenRequest :  IEquatable<AccessTokenRequest>, IValidatableObject
    {
        ...
        public AccessTokenRequest(string domain = default(string), string token = default(string), bool publicKeyRequired = default(bool))
        {
            ...
            if (domain == null)
            {
                throw new InvalidDataException("domain is a required property for AccessTokenRequest and cannot be null");
            }
            else
            {
                this.Domain = domain;
            ...
            if (token == null)
            {
                throw new InvalidDataException("token is a required property for AccessTokenRequest and cannot be null");
            }
            else
            {
                this.Token = token;
            ...
            if (publicKeyRequired == null)
            {
                throw new InvalidDataException("publicKeyRequired is a required property for AccessTokenRequest and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="publicKeyRequired", EmitDefaultValue=true)]
