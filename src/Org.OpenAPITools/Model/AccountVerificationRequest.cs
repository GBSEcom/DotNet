...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AccountVerificationRequest :  IEquatable<AccountVerificationRequest>, IValidatableObject
    {
        ...
        public AccountVerificationRequest(string requestType = default(string), Address billingAddress = default(Address), string storeId = default(string), AdditionalDetails additionalDetails = default(AdditionalDetails))
        {
            // to ensure "requestType" is required (not null)
            if (requestType == null)
            {
                throw new InvalidDataException("requestType is a required property for AccountVerificationRequest and cannot be null");
            }
            else
            {
