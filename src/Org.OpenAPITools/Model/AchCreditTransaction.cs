...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AchCreditTransaction")]
    ...
    public partial class AchCreditTransaction : PrimaryTransaction, IEquatable<AchCreditTransaction>, IValidatableObject
    {
        ...
        /// <param name="requestType">Object name of the primary transaction request. (required) (default to &quot;AchCreditTransaction&quot;).</param>
        ...
        public AchCreditTransaction(TeleCheckAchPaymentMethod paymentMethod = default(TeleCheckAchPaymentMethod), string requestType = "AchCreditTransaction", Amount transactionAmount = default(Amount), string storeId = default(string), string merchantTransactionId = default(string), TransactionOrigin? transactionOrigin = default(TransactionOrigin?), Order order = default(Order), long? ipgTransactionId = default(long?), bool allowPartialApproval = default(bool)) : base(requestType, transactionAmount, storeId, merchantTransactionId, transactionOrigin, order, ipgTransactionId, allowPartialApproval)
        {
