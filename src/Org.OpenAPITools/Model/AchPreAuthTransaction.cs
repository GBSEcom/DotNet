...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AchPreAuthTransaction : PrimaryTransaction,  IEquatable<AchPreAuthTransaction>, IValidatableObject
    {
        ...
        public AchPreAuthTransaction(TeleCheckAchPaymentMethod paymentMethod = default(TeleCheckAchPaymentMethod), string requestType = default(string), Amount transactionAmount = default(Amount), string storeId = default(string), string merchantTransactionId = default(string), TransactionOrigin? transactionOrigin = default(TransactionOrigin?), Order order = default(Order)) : base(requestType, transactionAmount, storeId, merchantTransactionId, transactionOrigin, order)
        {
            // to ensure "paymentMethod" is required (not null)
            if (paymentMethod == null)
            {
                throw new InvalidDataException("paymentMethod is a required property for AchPreAuthTransaction and cannot be null");
            }
            else
            {
