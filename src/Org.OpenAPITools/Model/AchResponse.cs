...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AchResponse : IEquatable<AchResponse>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.PreferredFlag != null)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PreferredFlag, cannot be null.", new [] { "PreferredFlag" });
            }

            // TransactionStatus (string) maxLength
            if(this.TransactionStatus != null)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TransactionStatus, cannot be null.", new [] { "TransactionStatus" });
            }
