...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AchSaleTransaction")]
    [JsonConverter(typeof(JsonSubtypes), "RequestType")]
    public partial class AchSaleTransaction : PrimaryTransaction, IEquatable<AchSaleTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchSaleTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AchSaleTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AchSaleTransaction" /> class.
        /// </summary>
        /// <param name="paymentMethod">paymentMethod (required).</param>
        /// <param name="requestType">Object name of the primary transaction request. (required) (default to &quot;AchSaleTransaction&quot;).</param>
        ...
        public AchSaleTransaction(TeleCheckAchPaymentMethod paymentMethod = default(TeleCheckAchPaymentMethod), string requestType = "AchSaleTransaction", Amount transactionAmount = default(Amount), string storeId = default(string), string merchantTransactionId = default(string), TransactionOrigin? transactionOrigin = default(TransactionOrigin?), Order order = default(Order), long? ipgTransactionId = default(long?), bool allowPartialApproval = default(bool)) : base(requestType, transactionAmount, storeId, merchantTransactionId, transactionOrigin, order, ipgTransactionId, allowPartialApproval)
        {
            // to ensure "paymentMethod" is required (not null)
            this.PaymentMethod = paymentMethod ?? throw new ArgumentNullException("paymentMethod is a required property for AchSaleTransaction and cannot be null");
        }
        ...
        {
            return this.Equals(input as AchSaleTransaction);
        }

        /// <summary>
        /// Returns true if AchSaleTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of AchSaleTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchSaleTransaction input)
        {
            if (input == null)
                return false;
