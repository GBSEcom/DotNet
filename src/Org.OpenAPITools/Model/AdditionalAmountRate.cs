...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AdditionalAmountRate :  IEquatable<AdditionalAmountRate>, IValidatableObject
    {
        ...
        public AdditionalAmountRate(decimal amount = default(decimal), decimal rate = default(decimal))
        {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for AdditionalAmountRate and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (rate == null)
            {
                throw new InvalidDataException("rate is a required property for AdditionalAmountRate and cannot be null");
            }
            else
            {
                this.Rate = rate;
