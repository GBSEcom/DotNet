...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AdditionalDetails : IEquatable<AdditionalDetails>, IValidatableObject
    {
        ...
        public enum ScaExemptionTypeEnum
        {
            ...
            /// <summary>
            /// Enum AuthenticationOutageException for value: Authentication Outage Exception
            /// </summary>
            [EnumMember(Value = "Authentication Outage Exception")]
            AuthenticationOutageException = 6
        ...
        /// <param name="mrchntRefData">Merchant Reference Data 2..</param>
        ...
        public AdditionalDetails(string comments = default(string), string invoiceNumber = default(string), string purchaseOrderNumber = default(string), string mrchntRefData = default(string), string operatorId = default(string), string salesSystemId = default(string), bool ipgDeferredAuth = default(bool), bool highRiskPurchaseIndicator = default(bool), List<ReceiptRequestInfo> receipts = default(List<ReceiptRequestInfo>), ScaExemptionTypeEnum? scaExemptionType = default(ScaExemptionTypeEnum?), string scaVisaMerchantID = default(string), BusinessApplicationIdentifierEnum? businessApplicationIdentifier = default(BusinessApplicationIdentifierEnum?))
        {
            this.Comments = comments;
            this.InvoiceNumber = invoiceNumber;
            this.PurchaseOrderNumber = purchaseOrderNumber;
            this.MrchntRefData = mrchntRefData;
        ...
        /// </summary>
        /// <value>Merchant Reference Data 2.</value>
        [DataMember(Name = "mrchntRefData", EmitDefaultValue = false)]
        public string MrchntRefData { get; set; }
        ...
        [DataMember(Name = "ipgDeferredAuth", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "highRiskPurchaseIndicator", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MrchntRefData: ").Append(MrchntRefData).Append("\n");
        ...
        public bool Equals(AdditionalDetails input)
        {
            ...
            return 
                ...
                (
                    this.MrchntRefData == input.MrchntRefData ||
                    (this.MrchntRefData != null &&
                    this.MrchntRefData.Equals(input.MrchntRefData))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MrchntRefData != null)
                    hashCode = hashCode * 59 + this.MrchntRefData.GetHashCode();
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // MrchntRefData (string) maxLength
            if(this.MrchntRefData != null && this.MrchntRefData.Length > 30)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MrchntRefData, length must be less than 30.", new [] { "MrchntRefData" });
            }
