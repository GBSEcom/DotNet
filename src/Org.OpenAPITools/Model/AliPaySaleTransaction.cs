...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AliPaySaleTransaction")]
    [JsonConverter(typeof(JsonSubtypes), "RequestType")]
    public partial class AliPaySaleTransaction : PrimaryTransaction, IEquatable<AliPaySaleTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AliPaySaleTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AliPaySaleTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AliPaySaleTransaction" /> class.
        /// </summary>
        /// <param name="paymentMethod">paymentMethod (required).</param>
        /// <param name="requestType">Object name of the primary transaction request. (required) (default to &quot;AliPaySaleTransaction&quot;).</param>
        ...
        public AliPaySaleTransaction(AliPayPaymentMethod paymentMethod = default(AliPayPaymentMethod), string requestType = "AliPaySaleTransaction", Amount transactionAmount = default(Amount), string storeId = default(string), string merchantTransactionId = default(string), TransactionOrigin? transactionOrigin = default(TransactionOrigin?), Order order = default(Order), long? ipgTransactionId = default(long?), bool allowPartialApproval = default(bool)) : base(requestType, transactionAmount, storeId, merchantTransactionId, transactionOrigin, order, ipgTransactionId, allowPartialApproval)
        {
            // to ensure "paymentMethod" is required (not null)
            this.PaymentMethod = paymentMethod ?? throw new ArgumentNullException("paymentMethod is a required property for AliPaySaleTransaction and cannot be null");
        }
        ...
        {
            return this.Equals(input as AliPaySaleTransaction);
        }

        /// <summary>
        /// Returns true if AliPaySaleTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of AliPaySaleTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AliPaySaleTransaction input)
        {
            if (input == null)
                return false;
