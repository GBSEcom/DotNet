...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApmSaleTransaction")]
    [JsonConverter(typeof(JsonSubtypes), "RequestType")]
    public partial class ApmSaleTransaction : PrimaryTransaction, IEquatable<ApmSaleTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApmSaleTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApmSaleTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApmSaleTransaction" /> class.
        /// </summary>
        /// <param name="paymentMethod">paymentMethod (required).</param>
        /// <param name="requestType">Object name of the primary transaction request. (required) (default to &quot;ApmSaleTransaction&quot;).</param>
        ...
        {
            return this.Equals(input as ApmSaleTransaction);
        }

        /// <summary>
        /// Returns true if ApmSaleTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of ApmSaleTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApmSaleTransaction input)
        {
            if (input == null)
                return false;
