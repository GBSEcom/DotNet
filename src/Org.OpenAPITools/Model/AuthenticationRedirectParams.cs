...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthenticationRedirectParams :  IEquatable<AuthenticationRedirectParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticationRedirectParams" /> class.
        /// </summary>
        ...
        public AuthenticationRedirectParams(string payerAuthenticationRequest = default(string), string termUrl = default(string), string merchantData = default(string))
        {
        ...
        {
            return this.Equals(input as AuthenticationRedirectParams);
        }

        /// <summary>
        /// Returns true if AuthenticationRedirectParams instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticationRedirectParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticationRedirectParams input)
        {
            if (input == null)
                return false;
