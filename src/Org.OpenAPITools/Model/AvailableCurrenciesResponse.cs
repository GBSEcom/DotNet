...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AvailableCurrenciesResponse")]
    public partial class AvailableCurrenciesResponse : IEquatable<AvailableCurrenciesResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AvailableCurrenciesResponse" /> class.
        /// </summary>
        ...
        public AvailableCurrenciesResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = default(ResponseType?), List<StoreCurrency> currencies = default(List<StoreCurrency>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AvailableCurrenciesResponse {\n");
        ...
        {
            return this.Equals(input as AvailableCurrenciesResponse);
        }

        /// <summary>
        /// Returns true if AvailableCurrenciesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AvailableCurrenciesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AvailableCurrenciesResponse input)
        {
            if (input == null)
                return false;
