...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AvailableCurrenciesResponse : IEquatable<AvailableCurrenciesResponse>, IValidatableObject
    {
        ...
        public AvailableCurrenciesResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = default(ResponseType?), List<string> currencies = default(List<string>))
        {
