...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BillingAddress :  IEquatable<BillingAddress>, IValidatableObject
    {
        ...
        public BillingAddress(string firstName = default(string), string lastName = default(string), string middleName = default(string), string street = default(string), string street2 = default(string), string stateProvince = default(string), string city = default(string), string country = default(string), BillingAddressPhone phone = default(BillingAddressPhone), string zipPostalCode = default(string))
        {
