...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BrandingStyleConfigurationResponse : IEquatable<BrandingStyleConfigurationResponse>, IValidatableObject
    {
        ...
        public BrandingStyleConfigurationResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = null, List<BrandingStyleConfigurationResult> stores = default(List<BrandingStyleConfigurationResult>))
        {
