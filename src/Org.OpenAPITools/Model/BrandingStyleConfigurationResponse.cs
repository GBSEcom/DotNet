...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrandingStyleConfigurationResponse :  IEquatable<BrandingStyleConfigurationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandingStyleConfigurationResponse" /> class.
        /// </summary>
        ...
        public BrandingStyleConfigurationResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType responseType = default(ResponseType), List<BrandingStyleConfigurationResult> stores = default(List<BrandingStyleConfigurationResult>))
        {
        ...
        {
            return this.Equals(input as BrandingStyleConfigurationResponse);
        }

        /// <summary>
        /// Returns true if BrandingStyleConfigurationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BrandingStyleConfigurationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrandingStyleConfigurationResponse input)
        {
            if (input == null)
                return false;
