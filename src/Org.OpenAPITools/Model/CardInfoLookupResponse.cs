...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CardInfoLookupResponse : IEquatable<CardInfoLookupResponse>, IValidatableObject
    {
        ...
        public CardInfoLookupResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType responseType = default(ResponseType), List<CardInfo> cardDetails = default(List<CardInfo>), RequestStatusEnum? requestStatus = null)
        {
