...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ChinaDomesticPaymentMethod :  IEquatable<ChinaDomesticPaymentMethod>, IValidatableObject
    {
        ...
        public ChinaDomesticPaymentMethod(ChinaDomestic chinaDomestic = default(ChinaDomestic), BrandEnum brand = default(BrandEnum))
        {
            ...
            {
                throw new InvalidDataException("chinaDomestic is a required property for ChinaDomesticPaymentMethod and cannot be null");
            }
            else
            {
            ...
            if (brand == null)
            {
                throw new InvalidDataException("brand is a required property for ChinaDomesticPaymentMethod and cannot be null");
            }
            else
            {
                this.Brand = brand;
        ...
        /// </summary>
        [DataMember(Name="chinaDomestic", EmitDefaultValue=true)]
