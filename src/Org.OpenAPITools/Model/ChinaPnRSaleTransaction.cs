...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChinaPnRSaleTransaction : PrimaryTransaction,  IEquatable<ChinaPnRSaleTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChinaPnRSaleTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChinaPnRSaleTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChinaPnRSaleTransaction" /> class.
        /// </summary>
        ...
        public ChinaPnRSaleTransaction(ChinaDomesticPaymentMethod paymentMethod = default(ChinaDomesticPaymentMethod), string requestType = default(string), Amount transactionAmount = default(Amount), string storeId = default(string), string merchantTransactionId = default(string), TransactionOrigin transactionOrigin = default(TransactionOrigin), Order order = default(Order)) : base(requestType, transactionAmount, storeId, merchantTransactionId, transactionOrigin, order)
        {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for ChinaPnRSaleTransaction and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ChinaPnRSaleTransaction);
        }

        /// <summary>
        /// Returns true if ChinaPnRSaleTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of ChinaPnRSaleTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChinaPnRSaleTransaction input)
        {
            if (input == null)
                return false;
