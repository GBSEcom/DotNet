...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ClientRegistration :  IEquatable<ClientRegistration>, IValidatableObject
    {
        ...
        public ClientRegistration(string merchantRef = default(string), string transactionType = default(string), Customer customer = default(Customer), Merchant merchant = default(Merchant), FraudRegistrationDevice device = default(FraudRegistrationDevice), Object userDefined = default(Object), string originalTransactionType = default(string))
        {
            ...
            {
                throw new InvalidDataException("transactionType is a required property for ClientRegistration and cannot be null");
            }
            else
            {
            ...
            if (customer == null)
            {
                throw new InvalidDataException("customer is a required property for ClientRegistration and cannot be null");
            }
            else
            {
            ...
            if (merchant == null)
            {
                throw new InvalidDataException("merchant is a required property for ClientRegistration and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("originalTransactionType is a required property for ClientRegistration and cannot be null");
            }
            else
            {
