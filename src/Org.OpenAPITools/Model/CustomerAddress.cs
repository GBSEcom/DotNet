...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CustomerAddress : IEquatable<CustomerAddress>, IValidatableObject
    {
        ...
        public CustomerAddress(string street = default(string), string street2 = default(string), string stateProvince = default(string), string city = default(string), string country = default(string), string zipPostalCode = default(string), Phone phone = default(Phone))
        {
            ...
            this.Street = street ?? throw new ArgumentNullException("street is a required property for CustomerAddress and cannot be null");
            // to ensure "country" is required (not null)
            this.Country = country ?? throw new ArgumentNullException("country is a required property for CustomerAddress and cannot be null");
            // to ensure "zipPostalCode" is required (not null)
            this.ZipPostalCode = zipPostalCode ?? throw new ArgumentNullException("zipPostalCode is a required property for CustomerAddress and cannot be null");
