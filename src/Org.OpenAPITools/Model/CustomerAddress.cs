...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CustomerAddress :  IEquatable<CustomerAddress>, IValidatableObject
    {
        ...
        public CustomerAddress(string street = default(string), string street2 = default(string), string stateProvince = default(string), string city = default(string), string country = default(string), CustomerAddressPhone phone = default(CustomerAddressPhone), string zipPostalCode = default(string))
        {
