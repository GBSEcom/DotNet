...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Dcc : CurrencyConversion, IEquatable<Dcc>, IValidatableObject
    {
        ...
        /// <param name="conversionType">Type of currency conversion. (required) (default to &quot;Dcc&quot;).</param>
        /// <param name="inquiryRateId">Inquiry rate id. (required).</param>
        public Dcc(bool dccApplied = default(bool), string conversionType = "Dcc", string inquiryRateId = default(string)) : base(conversionType, inquiryRateId)
        {
