...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DecryptedGooglePay : IEquatable<DecryptedGooglePay>, IValidatableObject
    {
        ...
        public DecryptedGooglePay(string accountNumber = default(string), string expiration = default(string), string cardholderName = default(string), string brand = default(string), string cryptogram = default(string), string eciIndicator = default(string))
        {
