...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DeleteBrandingStyleConfigurationResponse : IEquatable<DeleteBrandingStyleConfigurationResponse>, IValidatableObject
    {
        ...
        public DeleteBrandingStyleConfigurationResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = null, string storeId = default(string), string status = default(string))
        {
