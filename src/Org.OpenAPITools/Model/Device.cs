...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Device :  IEquatable<Device>, IValidatableObject
    {
        ...
        public Device(DeviceTypeEnum deviceType = default(DeviceTypeEnum), string deviceId = default(string), List<DeviceNetworks> networks = default(List<DeviceNetworks>), decimal latitude = default(decimal), decimal longitude = default(decimal), string imei = default(string), string model = default(string), string manufacturer = default(string), string timezoneOffset = default(string), bool rooted = default(bool), bool malwareDetected = default(bool), Object userDefined = default(Object))
        {
