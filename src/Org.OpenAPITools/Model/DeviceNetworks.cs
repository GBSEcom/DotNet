...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceNetworks :  IEquatable<DeviceNetworks>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceNetworks" /> class.
        /// </summary>
        ...
        public DeviceNetworks(NetworkTypeEnum networkType = default(NetworkTypeEnum), string ip = default(string), string phoneNumber = default(string), string carrierName = default(string), string mobileCountryCode = default(string), string mobileNetworkCode = default(string), string subscriptionIdentificationNumber = default(string), string locationAreaCode = default(string), string cellId = default(string), string standard = default(string), string mac = default(string), string ssid = default(string), string bssid = default(string), Object userDefined = default(Object))
        {
        ...
        {
            return this.Equals(input as DeviceNetworks);
        }

        /// <summary>
        /// Returns true if DeviceNetworks instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceNetworks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceNetworks input)
        {
            if (input == null)
                return false;
