...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Disbursement :  IEquatable<Disbursement>, IValidatableObject
    {
        ...
        [DataMember(Name="disbursementType", EmitDefaultValue=true)]
        public string DisbursementType { get; set; }

        /// <summary>
        /// Gets or Sets SenderInfo
        /// </summary>
        [DataMember(Name="senderInfo", EmitDefaultValue=true)]
        public SenderInfo SenderInfo { get; set; }

        /// <summary>
        /// Gets or Sets ReceiverInfo
        /// </summary>
        [DataMember(Name="receiverInfo", EmitDefaultValue=true)]
