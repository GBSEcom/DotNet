...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Disbursement : IEquatable<Disbursement>, IValidatableObject
    {
        ...
        [DataMember(Name = "disbursementType", IsRequired = true, EmitDefaultValue = false)]
        public string DisbursementType { get; set; }

        /// <summary>
        /// Gets or Sets SenderInfo
        /// </summary>
        [DataMember(Name = "senderInfo", IsRequired = true, EmitDefaultValue = false)]
        public SenderInfo SenderInfo { get; set; }

        /// <summary>
        /// Gets or Sets ReceiverInfo
        /// </summary>
        [DataMember(Name = "receiverInfo", IsRequired = true, EmitDefaultValue = false)]
