...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DynamicPricing : CurrencyConversion,  IEquatable<DynamicPricing>, IValidatableObject
    {
        ...
        public DynamicPricing(string foreignCurrency = default(string), string foreignAmount = default(string), string conversionType = default(string), string inquiryRateId = default(string)) : base(conversionType, inquiryRateId)
        {
            ...
            {
                throw new InvalidDataException("foreignCurrency is a required property for DynamicPricing and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("foreignAmount is a required property for DynamicPricing and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="foreignAmount", EmitDefaultValue=true)]
