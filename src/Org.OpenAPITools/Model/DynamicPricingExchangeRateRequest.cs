...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DynamicPricingExchangeRateRequest")]
    ...
    public partial class DynamicPricingExchangeRateRequest : ExchangeRateRequest, IEquatable<DynamicPricingExchangeRateRequest>, IValidatableObject
    {
        ...
        /// <param name="requestType">Object name of the exchange rate request. (required) (default to &quot;DynamicPricingExchangeRateRequest&quot;).</param>
        ...
        public DynamicPricingExchangeRateRequest(string foreignCurrency = default(string), string requestType = "DynamicPricingExchangeRateRequest", decimal baseAmount = default(decimal), string storeId = default(string)) : base(requestType, baseAmount, storeId)
        {
