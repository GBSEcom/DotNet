...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EncryptedGooglePay :  IEquatable<EncryptedGooglePay>, IValidatableObject
    {
        ...
        public EncryptedGooglePay(EncryptedGooglePayData data = default(EncryptedGooglePayData), string signature = default(string), string version = default(string))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for EncryptedGooglePay and cannot be null");
            }
            else
            {
                this.Data = data;
            ...
            if (signature == null)
            {
                throw new InvalidDataException("signature is a required property for EncryptedGooglePay and cannot be null");
            }
            else
            {
            ...
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for EncryptedGooglePay and cannot be null");
            }
            else
            {
