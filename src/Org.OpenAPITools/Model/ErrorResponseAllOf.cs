...
namespace Org.OpenAPITools.Model
{
    ...
    /// ErrorResponseAllOf
    /// </summary>
    [DataContract(Name = "ErrorResponse_allOf")]
    public partial class ErrorResponseAllOf : IEquatable<ErrorResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorResponseAllOf" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public ErrorResponseAllOf(Error error = default(Error))
        {
            this.Error = error;
        }
