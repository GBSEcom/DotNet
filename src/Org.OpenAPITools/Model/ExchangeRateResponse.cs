...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ExchangeRateResponse : IEquatable<ExchangeRateResponse>, IValidatableObject
    {
        ...
        public ExchangeRateResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = null, string ipgTransactionId = default(string), string requestTime = default(string), ExchangeRateDetails exchangeRateDetails = default(ExchangeRateDetails))
        {
