...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Expiration :  IEquatable<Expiration>, IValidatableObject
    {
        ...
        /// <param name="year">Year of the card expiration date in YY or YYYY format. (required).</param>
        ...
        /// </summary>
        /// <value>Year of the card expiration date in YY or YYYY format.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Year (string) pattern
            Regex regexYear = new Regex(@"^(\\d{2})(\\d{2})?$", RegexOptions.CultureInvariant);
