...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Footer :  IEquatable<Footer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Footer" /> class.
        /// </summary>
        /// <param name="color">Hexadecimal color value..</param>
        public Footer(string color = default(string))
        {
            this.Color = color;
        }
        ...
        {
            return this.Equals(input as Footer);
        }

        /// <summary>
        /// Returns true if Footer instances are equal
        /// </summary>
        /// <param name="input">Instance of Footer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Footer input)
        {
            if (input == null)
                return false;
