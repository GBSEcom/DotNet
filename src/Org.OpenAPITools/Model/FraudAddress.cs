...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FraudAddress :  IEquatable<FraudAddress>, IValidatableObject
    {
        ...
        public FraudAddress(string street = default(string), string street2 = default(string), string stateProvince = default(string), string city = default(string), string country = default(string), string zipPostalCode = default(string))
        {
            ...
            if (street == null)
            {
                throw new InvalidDataException("street is a required property for FraudAddress and cannot be null");
            }
            else
            {
                this.Street = street;
            ...
            if (country == null)
            {
                throw new InvalidDataException("country is a required property for FraudAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("zipPostalCode is a required property for FraudAddress and cannot be null");
            }
            else
            {
