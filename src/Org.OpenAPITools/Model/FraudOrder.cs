...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FraudOrder :  IEquatable<FraudOrder>, IValidatableObject
    {
        ...
        public FraudOrder(FraudOrderShipToAddress shipToAddress = default(FraudOrderShipToAddress), List<FraudOrderItems> items = default(List<FraudOrderItems>), Object userDefined = default(Object))
        {
