...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FraudOrder :  IEquatable<FraudOrder>, IValidatableObject
    {
        ...
        public FraudOrder(ShipToAddress shipToAddress = default(ShipToAddress), List<FraudOrderItems> items = default(List<FraudOrderItems>), Object userDefined = default(Object))
        {
