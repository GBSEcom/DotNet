...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FraudOrderItems :  IEquatable<FraudOrderItems>, IValidatableObject
    {
        ...
        public FraudOrderItems(string id = default(string), string name = default(string), string quantity = default(string), decimal unit = default(decimal), string unitPrice = default(string), string categories = default(string), string detailsUrl = default(string), Object userDefined = default(Object))
        {
            this.Id = id;
            this.Name = name;
