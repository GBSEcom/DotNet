...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FraudRegistration :  IEquatable<FraudRegistration>, IValidatableObject
    {
        ...
        public FraudRegistration(string merchantRef = default(string), string transactionType = default(string), Customer customer = default(Customer), Merchant merchant = default(Merchant), FraudRegistrationDevice device = default(FraudRegistrationDevice), Object userDefined = default(Object))
        {
            ...
            {
                throw new InvalidDataException("transactionType is a required property for FraudRegistration and cannot be null");
            }
            else
            {
            ...
            if (customer == null)
            {
                throw new InvalidDataException("customer is a required property for FraudRegistration and cannot be null");
            }
            else
            {
            ...
            if (merchant == null)
            {
                throw new InvalidDataException("merchant is a required property for FraudRegistration and cannot be null");
            }
            else
            {
