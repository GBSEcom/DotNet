...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FraudRegistrationResponse")]
    public partial class FraudRegistrationResponse : IEquatable<FraudRegistrationResponse>, IValidatableObject
    {
        ...
        public FraudRegistrationResponse(string correlationId = default(string), TransactionStatusEnum? transactionStatus = default(TransactionStatusEnum?), string validationStatus = default(string), string transactionType = default(string), FraudScore fraudScore = default(FraudScore), FraudRegistrationError error = default(FraudRegistrationError))
        {
