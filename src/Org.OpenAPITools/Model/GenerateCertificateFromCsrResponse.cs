...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenerateCertificateFromCsrResponse : IEquatable<GenerateCertificateFromCsrResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateCertificateFromCsrResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenerateCertificateFromCsrResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateCertificateFromCsrResponse" /> class.
        /// </summary>
        ...
        /// <param name="certificate">Certificate file (x509) encoded in Base64. (required).</param>
        public GenerateCertificateFromCsrResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType responseType = default(ResponseType), string certificate = default(string))
        {
            // to ensure "certificate" is required (not null)
            this.Certificate = certificate ?? throw new ArgumentNullException("certificate is a required property for GenerateCertificateFromCsrResponse and cannot be null");
        ...
        /// </summary>
        /// <value>Certificate file (x509) encoded in Base64.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenerateCertificateFromCsrResponse {\n");
        ...
        {
            return this.Equals(input as GenerateCertificateFromCsrResponse);
        }

        /// <summary>
        /// Returns true if GenerateCertificateFromCsrResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateCertificateFromCsrResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateCertificateFromCsrResponse input)
        {
            if (input == null)
                return false;
