...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Hover : IEquatable<Hover>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Hover" /> class.
        /// </summary>
        /// <param name="color">Hexadecimal color value..</param>
        public Hover(string color = default(string))
        {
            this.Color = color;
        }
        ...
        {
            return this.Equals(input as Hover);
        }

        /// <summary>
        /// Returns true if Hover instances are equal
        /// </summary>
        /// <param name="input">Instance of Hover to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Hover input)
        {
            if (input == null)
                return false;
