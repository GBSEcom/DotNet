...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InitiateClearingResponse :  IEquatable<InitiateClearingResponse>, IValidatableObject
    {
        ...
        public InitiateClearingResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType responseType = default(ResponseType), RequestStatusEnum? requestStatus = default(RequestStatusEnum?), ClearingDetails clearingDetails = default(ClearingDetails), List<EndpointResponse> endpointResponses = default(List<EndpointResponse>))
        {
