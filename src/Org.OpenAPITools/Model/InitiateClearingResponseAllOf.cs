...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InitiateClearingResponseAllOf :  IEquatable<InitiateClearingResponseAllOf>, IValidatableObject
    {
        ...
        public InitiateClearingResponseAllOf(RequestStatusEnum? requestStatus = default(RequestStatusEnum?), ClearingDetails clearingDetails = default(ClearingDetails), List<EndpointResponse> endpointResponses = default(List<EndpointResponse>))
        {
