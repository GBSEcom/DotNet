...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InstallmentOptions : IEquatable<InstallmentOptions>, IValidatableObject
    {
        ...
        public InstallmentOptions(int numberOfInstallments = default(int), bool installmentsInterest = default(bool), int installmentDelayMonths = default(int), RecurringTypeEnum? recurringType = null, bool merchantAdviceCodeSupported = default(bool))
        {
