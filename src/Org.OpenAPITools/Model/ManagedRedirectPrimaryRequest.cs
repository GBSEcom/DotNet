...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagedRedirectPrimaryRequest")]
    [JsonConverter(typeof(JsonSubtypes), "RequestType")]
    [JsonSubtypes.KnownSubType(typeof(GenericManagedRedirectRequest), "GenericManagedRedirectRequest")]
    [JsonSubtypes.KnownSubType(typeof(PaymentCardManagedRedirectRequest), "PaymentCardManagedRedirectRequest")]
    public partial class ManagedRedirectPrimaryRequest : IEquatable<ManagedRedirectPrimaryRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagedRedirectPrimaryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ManagedRedirectPrimaryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagedRedirectPrimaryRequest" /> class.
        /// </summary>
        ...
        public ManagedRedirectPrimaryRequest(string requestType = default(string), Amount transactionAmount = default(Amount), string storeId = default(string), string merchantTransactionId = default(string), ManagedRedirectTransactionType? transactionType = default(ManagedRedirectTransactionType?), Order order = default(Order), RedirectAttributes redirectAttributes = default(RedirectAttributes))
        {
            // to ensure "requestType" is required (not null)
            this.RequestType = requestType ?? throw new ArgumentNullException("requestType is a required property for ManagedRedirectPrimaryRequest and cannot be null");
            // to ensure "transactionAmount" is required (not null)
            this.TransactionAmount = transactionAmount ?? throw new ArgumentNullException("transactionAmount is a required property for ManagedRedirectPrimaryRequest and cannot be null");
        ...
        {
            return this.Equals(input as ManagedRedirectPrimaryRequest);
        }

        /// <summary>
        /// Returns true if ManagedRedirectPrimaryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagedRedirectPrimaryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagedRedirectPrimaryRequest input)
        {
            if (input == null)
                return false;
