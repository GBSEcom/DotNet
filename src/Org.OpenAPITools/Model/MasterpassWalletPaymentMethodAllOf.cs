...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MasterpassWalletPaymentMethodAllOf :  IEquatable<MasterpassWalletPaymentMethodAllOf>, IValidatableObject
    {
        ...
        public MasterpassWalletPaymentMethodAllOf(string walletId = default(string), PaymentCard paymentCard = default(PaymentCard))
        {
            ...
            if (walletId == null)
            {
                throw new InvalidDataException("walletId is a required property for MasterpassWalletPaymentMethodAllOf and cannot be null");
            }
            else
            {
            ...
            if (paymentCard == null)
            {
                throw new InvalidDataException("paymentCard is a required property for MasterpassWalletPaymentMethodAllOf and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="walletId", EmitDefaultValue=true)]
