...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MaximumPurchaseAmount :  IEquatable<MaximumPurchaseAmount>, IValidatableObject
    {
        ...
        public MaximumPurchaseAmount(string currency = default(string), string maxAmount = default(string))
        {
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for MaximumPurchaseAmount and cannot be null");
            }
            else
            {
            ...
            if (maxAmount == null)
            {
                throw new InvalidDataException("maxAmount is a required property for MaximumPurchaseAmount and cannot be null");
            }
            else
            {
