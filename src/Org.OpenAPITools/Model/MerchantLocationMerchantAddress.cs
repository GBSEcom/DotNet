...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MerchantLocationMerchantAddress :  IEquatable<MerchantLocationMerchantAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantLocationMerchantAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MerchantLocationMerchantAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantLocationMerchantAddress" /> class.
        /// </summary>
        /// <param name="street">First line of street address. (required).</param>
        /// <param name="street2">Second line of street address..</param>
        /// <param name="stateProvince">Merchant state or provinceu..</param>
        /// <param name="city">Merchant city..</param>
        /// <param name="country">Merchant country. (required).</param>
        /// <param name="zipPostalCode">Merchant ZIP code. (required).</param>
        public MerchantLocationMerchantAddress(string street = default(string), string street2 = default(string), string stateProvince = default(string), string city = default(string), string country = default(string), string zipPostalCode = default(string))
        {
            // to ensure "street" is required (not null)
            if (street == null)
            {
                throw new InvalidDataException("street is a required property for MerchantLocationMerchantAddress and cannot be null");
            }
            else
            {
                this.Street = street;
            ...
            if (country == null)
            {
                throw new InvalidDataException("country is a required property for MerchantLocationMerchantAddress and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("zipPostalCode is a required property for MerchantLocationMerchantAddress and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as MerchantLocationMerchantAddress);
        }

        /// <summary>
        /// Returns true if MerchantLocationMerchantAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of MerchantLocationMerchantAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MerchantLocationMerchantAddress input)
        {
            if (input == null)
                return false;
