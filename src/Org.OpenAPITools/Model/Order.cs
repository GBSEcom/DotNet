...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Order : IEquatable<Order>, IValidatableObject
    {
        ...
        public Order(string orderId = default(string), Billing billing = default(Billing), Shipping shipping = default(Shipping), IndustrySpecificExtensions industrySpecificExtensions = default(IndustrySpecificExtensions), PurchaseCards purchaseCard = default(PurchaseCards), InstallmentOptions installmentOptions = default(InstallmentOptions), RevolvingOptions revolvingOptions = default(RevolvingOptions), SoftDescriptor softDescriptor = default(SoftDescriptor), AdditionalDetails additionalDetails = default(AdditionalDetails), BancontactQR bancontactQR = default(BancontactQR))
        {
