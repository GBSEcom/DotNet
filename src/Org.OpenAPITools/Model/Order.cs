...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Order : IEquatable<Order>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets StandInDetails
        /// </summary>
        [DataMember(Name = "standInDetails", EmitDefaultValue = false)]
        public StandInDetails StandInDetails { get; set; }
        ...
        /// <summary>
        /// Gets or Sets BancontactQR
        /// </summary>
        [DataMember(Name = "bancontactQR", EmitDefaultValue = false)]
        public BancontactQR BancontactQR { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StandInDetails: ").Append(StandInDetails).Append("\n");
            sb.Append("  SoftDescriptor: ").Append(SoftDescriptor).Append("\n");
            sb.Append("  AdditionalDetails: ").Append(AdditionalDetails).Append("\n");
            sb.Append("  BancontactQR: ").Append(BancontactQR).Append("\n");
        ...
        public bool Equals(Order input)
        {
            ...
            return 
                ...
                (
                    this.StandInDetails == input.StandInDetails ||
                    (this.StandInDetails != null &&
                    this.StandInDetails.Equals(input.StandInDetails))
                ) && 
                (
                ...
                (
                    this.BancontactQR == input.BancontactQR ||
                    (this.BancontactQR != null &&
                    this.BancontactQR.Equals(input.BancontactQR))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StandInDetails != null)
                    hashCode = hashCode * 59 + this.StandInDetails.GetHashCode();
                ...
                if (this.BancontactQR != null)
                    hashCode = hashCode * 59 + this.BancontactQR.GetHashCode();
