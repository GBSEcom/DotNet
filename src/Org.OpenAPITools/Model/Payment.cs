...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Payment :  IEquatable<Payment>, IValidatableObject
    {
        ...
        public enum EntryMethodEnum
        {
            ...
            /// <summary>
            /// Enum PinPresent for value: pinPresent
            /// </summary>
            [EnumMember(Value = "pinPresent")]
            PinPresent = 7
        ...
        /// <param name="payMethod">payMethod (required).</param>
        ...
        public Payment(PaymentTypeEnum paymentType = default(PaymentTypeEnum), PaymentPayMethod payMethod = default(PaymentPayMethod), bool pinPresent = default(bool), EntryMethodEnum entryMethod = default(EntryMethodEnum), PaymentIssuerResponse issuerResponse = default(PaymentIssuerResponse), string issuerApprovedAmount = default(string), string issuerCardBalance = default(string), PaymentVerificationAvs verificationAvs = default(PaymentVerificationAvs), PaymentVerification3ds verification3ds = default(PaymentVerification3ds), PaymentVerificationCvv verificationCvv = default(PaymentVerificationCvv), Object userDefined = default(Object))
        {
            this.PaymentType = paymentType;
            // to ensure "payMethod" is required (not null)
            if (payMethod == null)
            {
                throw new InvalidDataException("payMethod is a required property for Payment and cannot be null");
            }
            else
            {
            ...
            if (pinPresent == null)
            {
                throw new InvalidDataException("pinPresent is a required property for Payment and cannot be null");
            }
            else
            {
