...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentCard : IEquatable<PaymentCard>, IValidatableObject
    {
        ...
        public PaymentCard(string number = default(string), Expiration expiryDate = default(Expiration), string securityCode = default(string), CardFunction? cardFunction = null, string cardholderName = default(string), string bin = default(string), string last4 = default(string), string brand = default(string))
        {
