...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentCard :  IEquatable<PaymentCard>, IValidatableObject
    {
        ...
        public PaymentCard(string number = default(string), Expiration expiryDate = default(Expiration), string securityCode = default(string), CardFunction cardFunction = default(CardFunction), string cardholderName = default(string), Authentication authentication = default(Authentication), string bin = default(string), string last4 = default(string), string brand = default(string))
        {
            // to ensure "number" is required (not null)
            if (number == null)
            {
                throw new InvalidDataException("number is a required property for PaymentCard and cannot be null");
            }
            else
            {
                this.Number = number;
