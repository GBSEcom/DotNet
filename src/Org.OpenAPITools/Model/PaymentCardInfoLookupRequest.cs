...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentCardInfoLookupRequest")]
    ...
    public partial class PaymentCardInfoLookupRequest : AccountInfoLookupRequest, IEquatable<PaymentCardInfoLookupRequest>, IValidatableObject
    {
        ...
        /// <param name="requestType">Object name of the account verification request. (required) (default to &quot;PaymentCardInfoLookupRequest&quot;).</param>
        /// <param name="storeId">An optional outlet ID for clients that support multiple stores in the same app..</param>
        public PaymentCardInfoLookupRequest(PaymentCard paymentCard = default(PaymentCard), string requestType = "PaymentCardInfoLookupRequest", string storeId = default(string)) : base(requestType, storeId)
        {
