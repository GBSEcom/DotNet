...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentCardPaymentTokenUpdateRequest :  IEquatable<PaymentCardPaymentTokenUpdateRequest>, IValidatableObject
    {
        ...
        public PaymentCardPaymentTokenUpdateRequest(string requestType = default(string), string storeId = default(string), List<UpdatePaymentToken> paymentTokens = default(List<UpdatePaymentToken>))
        {
            ...
            if (requestType == null)
            {
                throw new InvalidDataException("requestType is a required property for PaymentCardPaymentTokenUpdateRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentTokens is a required property for PaymentCardPaymentTokenUpdateRequest and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="paymentTokens", EmitDefaultValue=true)]
