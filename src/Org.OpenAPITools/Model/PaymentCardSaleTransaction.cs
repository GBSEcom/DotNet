...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentCardSaleTransaction : PrimaryTransaction,  IEquatable<PaymentCardSaleTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentCardSaleTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentCardSaleTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentCardSaleTransaction" /> class.
        /// </summary>
        ...
        public PaymentCardSaleTransaction(string requestType = default(string), PaymentCardPaymentMethod paymentMethod = default(PaymentCardPaymentMethod), StoredCredential storedCredentials = default(StoredCredential), List<SubMerchantSplit> settlementSplit = default(List<SubMerchantSplit>), CreatePaymentToken createToken = default(CreatePaymentToken), CurrencyConversion currencyConversion = default(CurrencyConversion), AuthenticationRequest authenticationRequest = default(AuthenticationRequest), AuthenticationResult authenticationResult = default(AuthenticationResult), Amount transactionAmount = default(Amount), string storeId = default(string), string merchantTransactionId = default(string), TransactionOrigin? transactionOrigin = default(TransactionOrigin?), Order order = default(Order)) : base(requestType, transactionAmount, storeId, merchantTransactionId, transactionOrigin, order)
        {
            // to ensure "paymentMethod" is required (not null)
            if (paymentMethod == null)
            {
                throw new InvalidDataException("paymentMethod is a required property for PaymentCardSaleTransaction and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PaymentCardSaleTransaction);
        }

        /// <summary>
        /// Returns true if PaymentCardSaleTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentCardSaleTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentCardSaleTransaction input)
        {
            if (input == null)
                return false;
