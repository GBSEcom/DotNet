...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentCardVerificationRequest : AccountVerificationRequest,  IEquatable<PaymentCardVerificationRequest>, IValidatableObject
    {
        ...
        public PaymentCardVerificationRequest(PaymentCard paymentCard = default(PaymentCard), string requestType = default(string), Address billingAddress = default(Address), string storeId = default(string), AdditionalDetails additionalDetails = default(AdditionalDetails)) : base(requestType, billingAddress, storeId, additionalDetails)
        {
            // to ensure "paymentCard" is required (not null)
            if (paymentCard == null)
            {
                throw new InvalidDataException("paymentCard is a required property for PaymentCardVerificationRequest and cannot be null");
            }
            else
            {
