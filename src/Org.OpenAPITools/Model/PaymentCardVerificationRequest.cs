...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentCardVerificationRequest")]
    ...
    public partial class PaymentCardVerificationRequest : AccountVerificationRequest, IEquatable<PaymentCardVerificationRequest>, IValidatableObject
    {
        ...
        /// <param name="requestType">Object name of the account verification request. (required) (default to &quot;PaymentCardVerificationRequest&quot;).</param>
        ...
        public PaymentCardVerificationRequest(PaymentCard paymentCard = default(PaymentCard), string requestType = "PaymentCardVerificationRequest", Address billingAddress = default(Address), string storeId = default(string), string merchantTransactionId = default(string), AdditionalDetails additionalDetails = default(AdditionalDetails)) : base(requestType, billingAddress, storeId, merchantTransactionId, additionalDetails)
        {
