...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentFacilitator")]
    public partial class PaymentFacilitator : IEquatable<PaymentFacilitator>, IValidatableObject
    {
        ...
        [DataMember(Name = "externalMerchantId", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "paymentFacilitatorId", IsRequired = true, EmitDefaultValue = false)]
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            Regex regexPaymentFacilitatorId = new Regex(@"[a-zA-Z0-9]{1,11}", RegexOptions.CultureInvariant);
