...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentIssuerResponse :  IEquatable<PaymentIssuerResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentIssuerResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentIssuerResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentIssuerResponse" /> class.
        /// </summary>
        ...
        public PaymentIssuerResponse(string code = default(string), StatusEnum? status = default(StatusEnum?), string scheme = default(string))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for PaymentIssuerResponse and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (scheme == null)
            {
                throw new InvalidDataException("scheme is a required property for PaymentIssuerResponse and cannot be null");
            }
            else
            {
                this.Scheme = scheme;
        ...
        {
            return this.Equals(input as PaymentIssuerResponse);
        }

        /// <summary>
        /// Returns true if PaymentIssuerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentIssuerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentIssuerResponse input)
        {
            if (input == null)
                return false;
