...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentTokenDisbursementTransactionAllOf :  IEquatable<PaymentTokenDisbursementTransactionAllOf>, IValidatableObject
    {
        ...
        public PaymentTokenDisbursementTransactionAllOf(Disbursement disbursement = default(Disbursement), PaymentTokenPaymentMethod paymentMethod = default(PaymentTokenPaymentMethod), StoredCredential storedCredentials = default(StoredCredential))
        {
            ...
            {
                throw new InvalidDataException("disbursement is a required property for PaymentTokenDisbursementTransactionAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for PaymentTokenDisbursementTransactionAllOf and cannot be null");
            }
            else
            {
