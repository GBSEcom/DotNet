...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentTokenPaymentMethod :  IEquatable<PaymentTokenPaymentMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentTokenPaymentMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentTokenPaymentMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentTokenPaymentMethod" /> class.
        /// </summary>
        ...
        public PaymentTokenPaymentMethod(UsePaymentToken paymentToken = default(UsePaymentToken), PaymentFacilitator paymentFacilitator = default(PaymentFacilitator))
        {
            ...
            {
                throw new InvalidDataException("paymentToken is a required property for PaymentTokenPaymentMethod and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PaymentTokenPaymentMethod);
        }

        /// <summary>
        /// Returns true if PaymentTokenPaymentMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentTokenPaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentTokenPaymentMethod input)
        {
            if (input == null)
                return false;
