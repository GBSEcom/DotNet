...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentTokenPreAuthTransactionAllOf :  IEquatable<PaymentTokenPreAuthTransactionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentTokenPreAuthTransactionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentTokenPreAuthTransactionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentTokenPreAuthTransactionAllOf" /> class.
        /// </summary>
        ...
        public PaymentTokenPreAuthTransactionAllOf(PaymentTokenPaymentMethod paymentMethod = default(PaymentTokenPaymentMethod), StoredCredential storedCredentials = default(StoredCredential), SplitShipment splitShipment = default(SplitShipment), List<SubMerchantSplit> settlementSplit = default(List<SubMerchantSplit>))
        {
            // to ensure "paymentMethod" is required (not null)
            if (paymentMethod == null)
            {
                throw new InvalidDataException("paymentMethod is a required property for PaymentTokenPreAuthTransactionAllOf and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PaymentTokenPreAuthTransactionAllOf);
        }

        /// <summary>
        /// Returns true if PaymentTokenPreAuthTransactionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentTokenPreAuthTransactionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentTokenPreAuthTransactionAllOf input)
        {
            if (input == null)
                return false;
