...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentTokenPreAuthTransaction_allOf")]
    public partial class PaymentTokenPreAuthTransactionAllOf : IEquatable<PaymentTokenPreAuthTransactionAllOf>, IValidatableObject
    {
        ...
        public PaymentTokenPreAuthTransactionAllOf(PaymentTokenPaymentMethod paymentMethod = default(PaymentTokenPaymentMethod), StoredCredential storedCredentials = default(StoredCredential), SplitShipment splitShipment = default(SplitShipment), List<SubMerchantSplit> settlementSplit = default(List<SubMerchantSplit>), AuthenticationRequest authenticationRequest = default(AuthenticationRequest), AuthenticationResult authenticationResult = default(AuthenticationResult), bool decrementalFlag = false)
        {
            ...
            this.PaymentMethod = paymentMethod ?? throw new ArgumentNullException("paymentMethod is a required property for PaymentTokenPreAuthTransactionAllOf and cannot be null");
