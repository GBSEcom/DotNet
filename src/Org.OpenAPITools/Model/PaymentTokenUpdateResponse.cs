...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentTokenUpdateResponse")]
    public partial class PaymentTokenUpdateResponse : IEquatable<PaymentTokenUpdateResponse>, IValidatableObject
    {
        ...
        public PaymentTokenUpdateResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = default(ResponseType?), RequestStatusEnum? requestStatus = default(RequestStatusEnum?), long requestTime = default(long), List<Error> errors = default(List<Error>))
        {
        ...
        {
            return this.Equals(input as PaymentTokenUpdateResponse);
        }

        /// <summary>
        /// Returns true if PaymentTokenUpdateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentTokenUpdateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentTokenUpdateResponse input)
        {
            if (input == null)
                return false;
