...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentTokenUpdateResponse : IEquatable<PaymentTokenUpdateResponse>, IValidatableObject
    {
        ...
        public PaymentTokenUpdateResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType responseType = default(ResponseType), RequestStatusEnum? requestStatus = null, long requestTime = default(long), List<Error> errors = default(List<Error>))
        {
