...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentTokenizationRequest :  IEquatable<PaymentTokenizationRequest>, IValidatableObject
    {
        ...
        public PaymentTokenizationRequest(string requestType = default(string), string storeId = default(string), Address billingAddress = default(Address), CreatePaymentToken createToken = default(CreatePaymentToken), bool accountVerification = false, AdditionalDetails additionalDetails = default(AdditionalDetails))
        {
            // to ensure "requestType" is required (not null)
            if (requestType == null)
            {
                throw new InvalidDataException("requestType is a required property for PaymentTokenizationRequest and cannot be null");
            }
            else
            {
            ...
            if (createToken == null)
            {
                throw new InvalidDataException("createToken is a required property for PaymentTokenizationRequest and cannot be null");
            }
            else
            {
            ...
            // use default value if no "accountVerification" provided
        ...
        /// </summary>
        [DataMember(Name="createToken", EmitDefaultValue=true)]
