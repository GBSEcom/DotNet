...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentUrlDetail : IEquatable<PaymentUrlDetail>, IValidatableObject
    {
        ...
        public PaymentUrlDetail(string paymentUrl = default(string), string merchantTransactionId = default(string), string orderId = default(string), long requestTime = default(long), PaymentUrlStatus? status = null)
        {
