...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentUrlDetailResponse")]
    public partial class PaymentUrlDetailResponse : IEquatable<PaymentUrlDetailResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentUrlDetailResponse" /> class.
        /// </summary>
        ...
        public PaymentUrlDetailResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = default(ResponseType?), List<PaymentUrlDetail> paymentUrlDetails = default(List<PaymentUrlDetail>))
        {
        ...
        {
            return this.Equals(input as PaymentUrlDetailResponse);
        }

        /// <summary>
        /// Returns true if PaymentUrlDetailResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentUrlDetailResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentUrlDetailResponse input)
        {
            if (input == null)
                return false;
