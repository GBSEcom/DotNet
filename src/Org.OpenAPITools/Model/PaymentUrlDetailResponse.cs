...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentUrlDetailResponse : IEquatable<PaymentUrlDetailResponse>, IValidatableObject
    {
        ...
        public PaymentUrlDetailResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = null, List<PaymentUrlDetail> paymentUrlDetails = default(List<PaymentUrlDetail>))
        {
