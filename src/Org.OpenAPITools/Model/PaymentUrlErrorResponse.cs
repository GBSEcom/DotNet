...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentUrlErrorResponse : IEquatable<PaymentUrlErrorResponse>, IValidatableObject
    {
        ...
        public PaymentUrlErrorResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType responseType = default(ResponseType), RequestStatusEnum? requestStatus = null, string orderId = default(string), string paymentUrl = default(string), string transactionId = default(string), Error error = default(Error))
        {
