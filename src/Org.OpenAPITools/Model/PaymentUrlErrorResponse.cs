...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentUrlErrorResponse : IEquatable<PaymentUrlErrorResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public PaymentUrlErrorResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = null, RequestStatusEnum? requestStatus = null, string orderId = default(string), string paymentUrl = default(string), string transactionId = default(string), Error error = default(Error))
        {
        ...
        {
            return this.Equals(input as PaymentUrlErrorResponse);
        }

        /// <summary>
        /// Returns true if PaymentUrlErrorResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentUrlErrorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentUrlErrorResponse input)
        {
            if (input == null)
                return false;
