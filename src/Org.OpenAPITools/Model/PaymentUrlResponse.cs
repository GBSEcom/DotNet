...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentUrlResponse : IEquatable<PaymentUrlResponse>, IValidatableObject
    {
        ...
        public PaymentUrlResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType responseType = default(ResponseType), RequestStatusEnum? requestStatus = null, string orderId = default(string), string paymentUrl = default(string), string transactionId = default(string))
        {
