...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentUrlResponseAllOf : IEquatable<PaymentUrlResponseAllOf>, IValidatableObject
    {
        ...
        public PaymentUrlResponseAllOf(RequestStatusEnum? requestStatus = null, string orderId = default(string), string paymentUrl = default(string), string transactionId = default(string))
        {
