...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentVerification3ds :  IEquatable<PaymentVerification3ds>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentVerification3ds" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentVerification3ds() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentVerification3ds" /> class.
        /// </summary>
        ...
        public PaymentVerification3ds(string code = default(string), string status = default(string), string scheme = default(string))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for PaymentVerification3ds and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (scheme == null)
            {
                throw new InvalidDataException("scheme is a required property for PaymentVerification3ds and cannot be null");
            }
            else
            {
                this.Scheme = scheme;
        ...
        {
            return this.Equals(input as PaymentVerification3ds);
        }

        /// <summary>
        /// Returns true if PaymentVerification3ds instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentVerification3ds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentVerification3ds input)
        {
            if (input == null)
                return false;
