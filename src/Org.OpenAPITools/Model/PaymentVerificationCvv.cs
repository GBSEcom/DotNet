...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentVerificationCvv :  IEquatable<PaymentVerificationCvv>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentVerificationCvv" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentVerificationCvv() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentVerificationCvv" /> class.
        /// </summary>
        /// <param name="code">CVV response code. (required).</param>
        /// <param name="status">Interpretation of the response code..</param>
        /// <param name="scheme">Identifier of the scheme. (required).</param>
        public PaymentVerificationCvv(string code = default(string), string status = default(string), string scheme = default(string))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for PaymentVerificationCvv and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (scheme == null)
            {
                throw new InvalidDataException("scheme is a required property for PaymentVerificationCvv and cannot be null");
            }
            else
            {
                this.Scheme = scheme;
        ...
        {
            return this.Equals(input as PaymentVerificationCvv);
        }

        /// <summary>
        /// Returns true if PaymentVerificationCvv instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentVerificationCvv to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentVerificationCvv input)
        {
            if (input == null)
                return false;
