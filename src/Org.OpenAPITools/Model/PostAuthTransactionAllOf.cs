...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PostAuthTransactionAllOf : IEquatable<PostAuthTransactionAllOf>, IValidatableObject
    {
        ...
        public PostAuthTransactionAllOf(Amount transactionAmount = default(Amount), TransactionOrigin? transactionOrigin = null, SplitShipment splitShipment = default(SplitShipment), SoftDescriptor softDescriptor = default(SoftDescriptor))
        {
