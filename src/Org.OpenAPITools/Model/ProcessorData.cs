...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProcessorData : IEquatable<ProcessorData>, IValidatableObject
    {
        ...
        public ProcessorData(string referenceNumber = default(string), string authorizationCode = default(string), string responseCode = default(string), string network = default(string), string associationResponseCode = default(string), string responseMessage = default(string), AVSResponse avsResponse = default(AVSResponse), SecurityCodeResponseEnum? securityCodeResponse = null, string merchantAdviceCodeIndicator = default(string), string responseIndicator = default(string), string debitReceiptNumber = default(string), string transactionIntegrityClass = default(string))
        {
