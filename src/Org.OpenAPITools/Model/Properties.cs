...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Properties : IEquatable<Properties>, IValidatableObject
    {
        ...
        public Properties(FontFace? fontFace = null, string fontSize = default(string), FontWeight? fontWeight = null, string fontColor = default(string), string color = default(string))
        {
