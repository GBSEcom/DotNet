...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RemoveFraudBlockedItemsResponse : IEquatable<RemoveFraudBlockedItemsResponse>, IValidatableObject
    {
        ...
        public RemoveFraudBlockedItemsResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = null, string status = default(string))
        {
