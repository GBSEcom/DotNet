...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoveFraudBlockedItemsResponse :  IEquatable<RemoveFraudBlockedItemsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveFraudBlockedItemsResponse" /> class.
        /// </summary>
        ...
        public RemoveFraudBlockedItemsResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = default(ResponseType?), string status = default(string))
        {
        ...
        {
            return this.Equals(input as RemoveFraudBlockedItemsResponse);
        }

        /// <summary>
        /// Returns true if RemoveFraudBlockedItemsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveFraudBlockedItemsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveFraudBlockedItemsResponse input)
        {
            if (input == null)
                return false;
