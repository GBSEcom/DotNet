...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseAmountComponents")]
    public partial class ResponseAmountComponents : IEquatable<ResponseAmountComponents>, IValidatableObject
    {
        ...
        public ResponseAmountComponents(decimal subtotal = default(decimal), decimal vatAmount = default(decimal), decimal localTax = default(decimal), decimal shipping = default(decimal), decimal cashback = default(decimal), decimal tip = default(decimal), decimal surcharge = default(decimal), decimal convenienceFee = default(decimal))
        {
