...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ReturnTransaction : SecondaryTransaction,  IEquatable<ReturnTransaction>, IValidatableObject
    {
        ...
        public ReturnTransaction(Amount transactionAmount = default(Amount), SoftDescriptor softDescriptor = default(SoftDescriptor), CurrencyConversion currencyConversion = default(CurrencyConversion), string requestType = default(string), string storeId = default(string), string comments = default(string), Order order = default(Order)) : base(requestType, storeId, comments, order)
        {
            // to ensure "transactionAmount" is required (not null)
            if (transactionAmount == null)
            {
                throw new InvalidDataException("transactionAmount is a required property for ReturnTransaction and cannot be null");
            }
            else
            {
