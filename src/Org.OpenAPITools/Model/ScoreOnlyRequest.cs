...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ScoreOnlyRequest :  IEquatable<ScoreOnlyRequest>, IValidatableObject
    {
        ...
        {
            /// <summary>
            /// Enum ScoreOnly for value: scoreOnly
            /// </summary>
            [EnumMember(Value = "score_only")]
            ScoreOnly = 1
        ...
        public ScoreOnlyRequest(string merchantRef = default(string), TransactionTypeEnum transactionType = default(TransactionTypeEnum), OriginalTransactionTypeEnum originalTransactionType = default(OriginalTransactionTypeEnum), string originalTransactionId = default(string), string amount = default(string), string currencyCode = default(string), Customer customer = default(Customer), BillingAddress billingAddress = default(BillingAddress), Device device = default(Device), Loyalty loyalty = default(Loyalty), Payment payment = default(Payment), Merchant merchant = default(Merchant), FraudOrder order = default(FraudOrder), Object userDefined = default(Object))
        {
            ...
            {
                throw new InvalidDataException("originalTransactionId is a required property for ScoreOnlyRequest and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for ScoreOnlyRequest and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            {
                throw new InvalidDataException("currencyCode is a required property for ScoreOnlyRequest and cannot be null");
            }
            else
            {
            ...
            if (payment == null)
            {
                throw new InvalidDataException("payment is a required property for ScoreOnlyRequest and cannot be null");
            }
            else
            {
            ...
            if (merchant == null)
            {
                throw new InvalidDataException("merchant is a required property for ScoreOnlyRequest and cannot be null");
            }
            else
            {
