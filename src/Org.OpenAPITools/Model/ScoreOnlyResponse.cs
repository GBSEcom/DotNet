...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ScoreOnlyResponse :  IEquatable<ScoreOnlyResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="apiTraceId">Unique trace ID for issue triage..</param>
        ...
        public ScoreOnlyResponse(string apiTraceId = default(string), TransactionStatusEnum? transactionStatus = default(TransactionStatusEnum?), string validationStatus = default(string), string transactionType = default(string), ScoreOnlyResponseFraudScore fraudScore = default(ScoreOnlyResponseFraudScore), string recommendedDecision = default(string))
        {
