...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ScoreOnlyResponse : IEquatable<ScoreOnlyResponse>, IValidatableObject
    {
        ...
        public ScoreOnlyResponse(string correlationId = default(string), TransactionStatusEnum? transactionStatus = null, string validationStatus = default(string), string transactionType = default(string), ScoreOnlyResponseFraudScore fraudScore = default(ScoreOnlyResponseFraudScore))
        {
