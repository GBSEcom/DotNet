...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ScoreOnlyResponseFraudScore :  IEquatable<ScoreOnlyResponseFraudScore>, IValidatableObject
    {
        ...
        public ScoreOnlyResponseFraudScore(string score = default(string), List<string> warnings = default(List<string>), List<ScoreOnlyResponseFraudScoreExplanations> explanations = default(List<ScoreOnlyResponseFraudScoreExplanations>))
        {
            this.Score = score;
