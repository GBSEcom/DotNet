...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3D10AuthenticationUpdateRequest : AuthenticationUpdateRequest, IEquatable<Secure3D10AuthenticationUpdateRequest>, IValidatableObject
    {
        ...
        public Secure3D10AuthenticationUpdateRequest(string payerAuthenticationResponse = default(string), string merchantData = default(string), string securityCode = default(string), string storeId = default(string), string authenticationType = default(string), Address billingAddress = default(Address)) : base(storeId, authenticationType, billingAddress)
        {
            ...
            this.MerchantData = merchantData ?? throw new ArgumentNullException("merchantData is a required property for Secure3D10AuthenticationUpdateRequest and cannot be null");
