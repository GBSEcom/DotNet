...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3D21AuthenticationRequest : AuthenticationRequest, IEquatable<Secure3D21AuthenticationRequest>, IValidatableObject
    {
        ...
        public Secure3D21AuthenticationRequest(string termURL = default(string), string methodNotificationURL = default(string), ChallengeIndicatorEnum? challengeIndicator = ChallengeIndicatorEnum._01, ChallengeWindowSizeEnum? challengeWindowSize = null, bool? browserJavaScriptEnabled = default(bool?), RequestorAuthenticationIndicatorEnum? requestorAuthenticationIndicator = RequestorAuthenticationIndicatorEnum._01, string authenticationType = default(string)) : base(authenticationType)
        {
