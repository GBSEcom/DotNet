...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3D21AuthenticationRequestAllOf : IEquatable<Secure3D21AuthenticationRequestAllOf>, IValidatableObject
    {
        ...
        public Secure3D21AuthenticationRequestAllOf(string termURL = default(string), string methodNotificationURL = default(string), ChallengeIndicatorEnum? challengeIndicator = ChallengeIndicatorEnum._01, ChallengeWindowSizeEnum? challengeWindowSize = null, bool? browserJavaScriptEnabled = default(bool?), RequestorAuthenticationIndicatorEnum? requestorAuthenticationIndicator = RequestorAuthenticationIndicatorEnum._01)
        {
