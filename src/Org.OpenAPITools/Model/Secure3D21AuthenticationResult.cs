...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3D21AuthenticationResult : AuthenticationResult,  IEquatable<Secure3D21AuthenticationResult>, IValidatableObject
    {
        ...
        public Secure3D21AuthenticationResult(string cavv = default(string), string xid = default(string), string transactionId = default(string), AuthenticationResponseEnum? authenticationResponse = default(AuthenticationResponseEnum?), TransactionStatusEnum? transactionStatus = default(TransactionStatusEnum?), string authenticationType = default(string)) : base(authenticationType)
        {
            this.Cavv = cavv;
            this.Xid = xid;
