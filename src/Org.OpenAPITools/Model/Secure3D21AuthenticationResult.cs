...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Secure3D21AuthenticationResult : Authentication,  IEquatable<Secure3D21AuthenticationResult>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="transactionId">The response transaction ID. Only applicable to MasterCard..</param>
        /// <param name="authenticationResponse">The result of authentication attempt returned by the 3D Secure authentication process (PaRes)..</param>
        ...
        public Secure3D21AuthenticationResult(string cavv = default(string), string xid = default(string), Guid transactionId = default(Guid), AuthenticationResponseEnum? authenticationResponse = default(AuthenticationResponseEnum?), TransactionStatusEnum? transactionStatus = default(TransactionStatusEnum?), string requestType = default(string)) : base(requestType)
        {
            this.Cavv = cavv;
            this.Xid = xid;
        ...
        /// </summary>
        /// <value>The response transaction ID. Only applicable to MasterCard.</value>
