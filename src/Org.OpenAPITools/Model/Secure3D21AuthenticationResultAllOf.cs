...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3D21AuthenticationResultAllOf :  IEquatable<Secure3D21AuthenticationResultAllOf>, IValidatableObject
    {
        ...
        public Secure3D21AuthenticationResultAllOf(string cavv = default(string), string xid = default(string), string transactionId = default(string), AuthenticationResponseEnum? authenticationResponse = default(AuthenticationResponseEnum?), TransactionStatusEnum? transactionStatus = default(TransactionStatusEnum?))
        {
            this.Cavv = cavv;
            this.Xid = xid;
