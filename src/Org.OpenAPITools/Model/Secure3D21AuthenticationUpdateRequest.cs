...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Secure3D21AuthenticationUpdateRequest")]
    ...
    public partial class Secure3D21AuthenticationUpdateRequest : AuthenticationUpdateRequest, IEquatable<Secure3D21AuthenticationUpdateRequest>, IValidatableObject
    {
        ...
        /// <param name="authenticationType">Object name of the authentication update request. (required) (default to &quot;Secure3D21AuthenticationUpdateRequest&quot;).</param>
        /// <param name="billingAddress">billingAddress.</param>
        public Secure3D21AuthenticationUpdateRequest(MethodNotificationStatusEnum? methodNotificationStatus = default(MethodNotificationStatusEnum?), ACSResponse acsResponse = default(ACSResponse), string storeId = default(string), string authenticationType = "Secure3D21AuthenticationUpdateRequest", Address billingAddress = default(Address)) : base(storeId, authenticationType, billingAddress)
        {
