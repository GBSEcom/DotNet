...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3D21AuthenticationUpdateRequest : AuthenticationUpdateRequest,  IEquatable<Secure3D21AuthenticationUpdateRequest>, IValidatableObject
    {
        ...
        public Secure3D21AuthenticationUpdateRequest(MethodNotificationStatusEnum? methodNotificationStatus = default(MethodNotificationStatusEnum?), ACSResponse acsResponse = default(ACSResponse), string storeId = default(string), string authenticationType = default(string), Address billingAddress = default(Address)) : base(storeId, authenticationType, billingAddress)
        {
