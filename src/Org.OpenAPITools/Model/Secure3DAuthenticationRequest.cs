...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3DAuthenticationRequest : AuthenticationRequest, IEquatable<Secure3DAuthenticationRequest>, IValidatableObject
    {
        ...
        public Secure3DAuthenticationRequest(string termURL = default(string), string methodNotificationURL = default(string), ChallengeIndicatorEnum? challengeIndicator = ChallengeIndicatorEnum._01, MessageCategoryEnum? messageCategory = null, ChallengeWindowSizeEnum? challengeWindowSize = null, string authenticationType = default(string)) : base(authenticationType)
        {
