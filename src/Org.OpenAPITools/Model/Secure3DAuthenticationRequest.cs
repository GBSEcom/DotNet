...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Secure3DAuthenticationRequest")]
    [JsonConverter(typeof(JsonSubtypes), "AuthenticationType")]
    public partial class Secure3DAuthenticationRequest : AuthenticationRequest, IEquatable<Secure3DAuthenticationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="authenticationType">Indicates what kind of authentication scheme the merchant wants to use on the card. (required) (default to &quot;Secure3DAuthenticationRequest&quot;).</param>
        public Secure3DAuthenticationRequest(string termURL = default(string), string methodNotificationURL = default(string), ChallengeIndicatorEnum? challengeIndicator = ChallengeIndicatorEnum._01, MessageCategoryEnum? messageCategory = default(MessageCategoryEnum?), ChallengeWindowSizeEnum? challengeWindowSize = default(ChallengeWindowSizeEnum?), bool? browserJavaScriptEnabled = default(bool?), Secure3DDeviceChannelEnum? secure3DDeviceChannel = default(Secure3DDeviceChannelEnum?), Secure3DThreeRIIndicatorEnum? secure3DThreeRIIndicator = default(Secure3DThreeRIIndicatorEnum?), RequestorAuthenticationIndicatorEnum? requestorAuthenticationIndicator = RequestorAuthenticationIndicatorEnum._01, string authenticationType = "Secure3DAuthenticationRequest") : base(authenticationType)
        {
            // to ensure "termURL" is required (not null)
            this.TermURL = termURL ?? throw new ArgumentNullException("termURL is a required property for Secure3DAuthenticationRequest and cannot be null");
            // to ensure "methodNotificationURL" is required (not null)
            this.MethodNotificationURL = methodNotificationURL ?? throw new ArgumentNullException("methodNotificationURL is a required property for Secure3DAuthenticationRequest and cannot be null");
