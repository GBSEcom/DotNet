...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3DAuthenticationRequestAllOf : IEquatable<Secure3DAuthenticationRequestAllOf>, IValidatableObject
    {
        ...
        public Secure3DAuthenticationRequestAllOf(string termURL = default(string), string methodNotificationURL = default(string), ChallengeIndicatorEnum? challengeIndicator = ChallengeIndicatorEnum._01, MessageCategoryEnum? messageCategory = null, ChallengeWindowSizeEnum? challengeWindowSize = null, bool? browserJavaScriptEnabled = default(bool?), RequestorAuthenticationIndicatorEnum? requestorAuthenticationIndicator = RequestorAuthenticationIndicatorEnum._01)
        {
