...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Secure3DAuthenticationResponse")]
    public partial class Secure3DAuthenticationResponse : IEquatable<Secure3DAuthenticationResponse>, IValidatableObject
    {
        ...
        public Secure3DAuthenticationResponse(TypeEnum? type = default(TypeEnum?), VersionEnum? version = default(VersionEnum?), Secure3DAuthenticationResponseParams _params = default(Secure3DAuthenticationResponseParams), Secure3DAuthenticationResponseSecure3dMethod secure3dMethod = default(Secure3DAuthenticationResponseSecure3dMethod))
        {
            this.Type = type;
