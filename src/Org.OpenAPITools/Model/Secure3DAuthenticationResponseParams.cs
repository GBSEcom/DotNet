...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3DAuthenticationResponseParams :  IEquatable<Secure3DAuthenticationResponseParams>, IValidatableObject
    {
        ...
        /// <param name="cReq">The CReq message initiates cardholder interaction in a 3DS 2.1 challenge flow and carries authentication data from the cardholder..</param>
        ...
        /// </summary>
        /// <value>The CReq message initiates cardholder interaction in a 3DS 2.1 challenge flow and carries authentication data from the cardholder.</value>
