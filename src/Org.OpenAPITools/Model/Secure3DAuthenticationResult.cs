...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3DAuthenticationResult : AuthenticationResult, IEquatable<Secure3DAuthenticationResult>, IValidatableObject
    {
        ...
        public Secure3DAuthenticationResult(string cavv = default(string), string xid = default(string), string dsTransactionId = default(string), AuthenticationResponseEnum? authenticationResponse = null, TransactionStatusEnum? transactionStatus = null, MessageCategoryEnum? messageCategory = null, string authenticationType = default(string)) : base(authenticationType)
        {
            this.Cavv = cavv;
            this.Xid = xid;
