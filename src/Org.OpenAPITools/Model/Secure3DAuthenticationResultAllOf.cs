...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Secure3DAuthenticationResultAllOf : IEquatable<Secure3DAuthenticationResultAllOf>, IValidatableObject
    {
        ...
        public Secure3DAuthenticationResultAllOf(string cavv = default(string), string xid = default(string), string dsTransactionId = default(string), AuthenticationResponseEnum? authenticationResponse = null, TransactionStatusEnum? transactionStatus = null, MessageCategoryEnum? messageCategory = null)
        {
            this.Cavv = cavv;
            this.Xid = xid;
