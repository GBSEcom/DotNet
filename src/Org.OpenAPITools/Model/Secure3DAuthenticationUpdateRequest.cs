...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Secure3DAuthenticationUpdateRequest")]
    ...
    public partial class Secure3DAuthenticationUpdateRequest : AuthenticationUpdateRequest, IEquatable<Secure3DAuthenticationUpdateRequest>, IValidatableObject
    {
        ...
        /// <param name="authenticationType">Object name of the authentication update request. (required) (default to &quot;Secure3DAuthenticationUpdateRequest&quot;).</param>
        /// <param name="billingAddress">billingAddress.</param>
        public Secure3DAuthenticationUpdateRequest(MethodNotificationStatusEnum? methodNotificationStatus = default(MethodNotificationStatusEnum?), ACSResponse acsResponse = default(ACSResponse), string storeId = default(string), string authenticationType = "Secure3DAuthenticationUpdateRequest", Address billingAddress = default(Address)) : base(storeId, authenticationType, billingAddress)
        {
