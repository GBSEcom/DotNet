...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Secure3dAuthenticationVerificationRequest : AuthenticationVerificationRequest,  IEquatable<Secure3dAuthenticationVerificationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Secure3dAuthenticationVerificationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Secure3dAuthenticationVerificationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Secure3dAuthenticationVerificationRequest" /> class.
        /// </summary>
        ...
        public Secure3dAuthenticationVerificationRequest(string payerAuthenticationResponse = default(string), string merchantData = default(string), string storeId = default(string), string requestType = default(string), string securityCode = default(string), Address billingAddress = default(Address)) : base(storeId, requestType, securityCode, billingAddress)
        {
            // to ensure "payerAuthenticationResponse" is required (not null)
            if (payerAuthenticationResponse == null)
            {
                throw new InvalidDataException("payerAuthenticationResponse is a required property for Secure3dAuthenticationVerificationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("merchantData is a required property for Secure3dAuthenticationVerificationRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as Secure3dAuthenticationVerificationRequest);
        }

        /// <summary>
        /// Returns true if Secure3dAuthenticationVerificationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of Secure3dAuthenticationVerificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Secure3dAuthenticationVerificationRequest input)
        {
            if (input == null)
                return false;
