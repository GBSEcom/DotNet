...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SepaMandate :  IEquatable<SepaMandate>, IValidatableObject
    {
        ...
        public SepaMandate(string reference = default(string), string url = default(string), DateTime signatureDate = default(DateTime), TypeEnum type = TypeEnum.SINGLE)
        {
            ...
            if (reference == null)
            {
                throw new InvalidDataException("reference is a required property for SepaMandate and cannot be null");
            }
            else
            {
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for SepaMandate and cannot be null");
            }
            else
            {
                this.Url = url;
            ...
            {
                throw new InvalidDataException("signatureDate is a required property for SepaMandate and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for SepaMandate and cannot be null");
            }
            else
            {
                this.Type = type;
