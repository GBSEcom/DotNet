...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SepaSale : IEquatable<SepaSale>, IValidatableObject
    {
        ...
        public SepaSale(string iban = default(string), string name = default(string), string country = default(string), string email = default(string), SepaMandate mandate = default(SepaMandate))
        {
            ...
            this.Country = country ?? throw new ArgumentNullException("country is a required property for SepaSale and cannot be null");
