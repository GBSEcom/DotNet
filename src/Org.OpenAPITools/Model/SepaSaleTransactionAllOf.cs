...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SepaSaleTransaction_allOf")]
    public partial class SepaSaleTransactionAllOf : IEquatable<SepaSaleTransactionAllOf>, IValidatableObject
    {
        ...
        public SepaSaleTransactionAllOf(SepaSalePaymentMethod paymentMethod = default(SepaSalePaymentMethod))
        {
            // to ensure "paymentMethod" is required (not null)
            this.PaymentMethod = paymentMethod ?? throw new ArgumentNullException("paymentMethod is a required property for SepaSaleTransactionAllOf and cannot be null");
        }
