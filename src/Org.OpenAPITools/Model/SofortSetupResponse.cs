...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SofortSetupResponse : IEquatable<SofortSetupResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SofortSetupResponse" /> class.
        /// </summary>
        ...
        /// <param name="sofortSetup">sofortSetup.</param>
        public SofortSetupResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType responseType = default(ResponseType), SofortSetup sofortSetup = default(SofortSetup))
        {
        ...
        /// <summary>
        /// Gets or Sets SofortSetup
        /// </summary>
        [DataMember(Name = "SofortSetup", EmitDefaultValue = false)]
        public SofortSetup SofortSetup { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SofortSetup: ").Append(SofortSetup).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SofortSetupResponse);
        }

        /// <summary>
        /// Returns true if SofortSetupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SofortSetupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SofortSetupResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SofortSetup == input.SofortSetup ||
                    (this.SofortSetup != null &&
                    this.SofortSetup.Equals(input.SofortSetup))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SofortSetup != null)
                    hashCode = hashCode * 59 + this.SofortSetup.GetHashCode();
                return hashCode;
            }
        }
