...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class StoreEmailSettings : IEquatable<StoreEmailSettings>, IValidatableObject
    {
        ...
        public StoreEmailSettings(string id = default(string), EmailNotificationData emailNotificationData = default(EmailNotificationData))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for StoreEmailSettings and cannot be null");
            // to ensure "emailNotificationData" is required (not null)
            this.EmailNotificationData = emailNotificationData ?? throw new ArgumentNullException("emailNotificationData is a required property for StoreEmailSettings and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "emailNotificationData", EmitDefaultValue = false)]
