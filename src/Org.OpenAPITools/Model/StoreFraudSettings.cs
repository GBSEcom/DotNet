...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class StoreFraudSettings :  IEquatable<StoreFraudSettings>, IValidatableObject
    {
        ...
        public StoreFraudSettings(string id = default(string), FraudSettings fraudSettings = default(FraudSettings))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for StoreFraudSettings and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("fraudSettings is a required property for StoreFraudSettings and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="fraudSettings", EmitDefaultValue=true)]
