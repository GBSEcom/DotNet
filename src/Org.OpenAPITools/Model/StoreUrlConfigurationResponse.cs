...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreUrlConfigurationResponse : IEquatable<StoreUrlConfigurationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StoreUrlConfigurationResponse" /> class.
        /// </summary>
        ...
        public StoreUrlConfigurationResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType responseType = default(ResponseType), List<StoreUrlConfigurationResult> stores = default(List<StoreUrlConfigurationResult>))
        {
        ...
        public List<StoreUrlConfigurationResult> Stores { get; set; }
        ...
        {
            return this.Equals(input as StoreUrlConfigurationResponse);
        }

        /// <summary>
        /// Returns true if StoreUrlConfigurationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreUrlConfigurationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreUrlConfigurationResponse input)
        {
            if (input == null)
                return false;
