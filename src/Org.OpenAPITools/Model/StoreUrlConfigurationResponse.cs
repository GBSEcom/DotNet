...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class StoreUrlConfigurationResponse : IEquatable<StoreUrlConfigurationResponse>, IValidatableObject
    {
        ...
        public StoreUrlConfigurationResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = null, List<StoreUrlConfigurationResult> stores = default(List<StoreUrlConfigurationResult>))
        {
