...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class StoredCredential :  IEquatable<StoredCredential>, IValidatableObject
    {
        ...
        /// <param name="referencedSchemeTransactionId">The transaction ID received from schemes for the initial transaction. Required if sequence is &#39;SUBSEQUENT&#39;..</param>
        ...
        public StoredCredential(SequenceEnum sequence = default(SequenceEnum), bool scheduled = default(bool), string referencedSchemeTransactionId = default(string), InitiatorEnum? initiator = default(InitiatorEnum?))
        {
            ...
            if (scheduled == null)
            {
                throw new InvalidDataException("scheduled is a required property for StoredCredential and cannot be null");
            }
            else
            {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.ReferencedSchemeTransactionId != null && this.ReferencedSchemeTransactionId.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReferencedSchemeTransactionId, length must be less than 40.", new [] { "ReferencedSchemeTransactionId" });
            }
