...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SubMerchantSplit :  IEquatable<SubMerchantSplit>, IValidatableObject
    {
        ...
        public SubMerchantSplit(string merchantID = default(string), decimal amount = default(decimal))
        {
            ...
            if (merchantID == null)
            {
                throw new InvalidDataException("merchantID is a required property for SubMerchantSplit and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for SubMerchantSplit and cannot be null");
            }
            else
            {
                this.Amount = amount;
