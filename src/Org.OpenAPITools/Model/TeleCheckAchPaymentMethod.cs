...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TeleCheckAchPaymentMethod :  IEquatable<TeleCheckAchPaymentMethod>, IValidatableObject
    {
        ...
        public TeleCheckAchPaymentMethod(string achType = default(string), string routingNumber = default(string), string accountNumber = default(string), AccountTypeEnum accountType = default(AccountTypeEnum), string checkNumber = default(string), CheckTypeEnum checkType = default(CheckTypeEnum), string productCode = default(string), IdInfo manualIdInfo = default(IdInfo), IdInfo supplementIdInfo = default(IdInfo), string agentId = default(string), string terminalId = default(string), string registrationId = default(string), DateTime registrationDate = default(DateTime), ReleaseTypeEnum? releaseType = default(ReleaseTypeEnum?), VipCustomerEnum? vipCustomer = default(VipCustomerEnum?), string sessionId = default(string), string terminalState = default(string), string terminalCity = default(string), TeleCheckAchPaymentMethodAchBillTo achBillTo = default(TeleCheckAchPaymentMethodAchBillTo))
        {
            ...
            if (achType == null)
            {
                throw new InvalidDataException("achType is a required property for TeleCheckAchPaymentMethod and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("routingNumber is a required property for TeleCheckAchPaymentMethod and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accountNumber is a required property for TeleCheckAchPaymentMethod and cannot be null");
            }
            else
            {
            ...
            if (accountType == null)
            {
                throw new InvalidDataException("accountType is a required property for TeleCheckAchPaymentMethod and cannot be null");
            }
            else
            {
            ...
            if (checkType == null)
            {
                throw new InvalidDataException("checkType is a required property for TeleCheckAchPaymentMethod and cannot be null");
            }
            else
            {
            ...
            if (sessionId == null)
            {
                throw new InvalidDataException("sessionId is a required property for TeleCheckAchPaymentMethod and cannot be null");
            }
            else
            {
            ...
            if (achBillTo == null)
            {
                throw new InvalidDataException("achBillTo is a required property for TeleCheckAchPaymentMethod and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="achType", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="achBillTo", EmitDefaultValue=true)]
