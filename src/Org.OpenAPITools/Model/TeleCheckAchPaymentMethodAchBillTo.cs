...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TeleCheckAchPaymentMethodAchBillTo :  IEquatable<TeleCheckAchPaymentMethodAchBillTo>, IValidatableObject
    {
        ...
        public TeleCheckAchPaymentMethodAchBillTo(string firstName = default(string), string lastName = default(string), string addressOne = default(string), string addressTwo = default(string), string city = default(string), string state = default(string), string zip = default(string), string phone = default(string), string email = default(string), string countryCode = default(string))
        {
            ...
            if (lastName == null)
            {
                throw new InvalidDataException("lastName is a required property for TeleCheckAchPaymentMethodAchBillTo and cannot be null");
            }
            else
            {
            ...
            if (addressOne == null)
            {
                throw new InvalidDataException("addressOne is a required property for TeleCheckAchPaymentMethodAchBillTo and cannot be null");
            }
            else
            {
            ...
            if (city == null)
            {
                throw new InvalidDataException("city is a required property for TeleCheckAchPaymentMethodAchBillTo and cannot be null");
            }
            else
            {
                this.City = city;
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for TeleCheckAchPaymentMethodAchBillTo and cannot be null");
            }
            else
            {
                this.State = state;
            ...
            if (zip == null)
            {
                throw new InvalidDataException("zip is a required property for TeleCheckAchPaymentMethodAchBillTo and cannot be null");
            }
            else
            {
                this.Zip = zip;
            ...
            if (phone == null)
            {
                throw new InvalidDataException("phone is a required property for TeleCheckAchPaymentMethodAchBillTo and cannot be null");
            }
            else
            {
                this.Phone = phone;
        ...
        [DataMember(Name="addressOne", EmitDefaultValue=true)]
