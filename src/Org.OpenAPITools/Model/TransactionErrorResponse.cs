...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TransactionErrorResponse :  IEquatable<TransactionErrorResponse>, IValidatableObject
    {
        ...
        /// <param name="authenticationRedirect">authenticationRedirect.</param>
        ...
        public bool Equals(TransactionErrorResponse input)
        {
            ...
            return 
                ...
                (
                    this.AuthenticationRedirect == input.AuthenticationRedirect ||
                    (this.AuthenticationRedirect != null &&
                    this.AuthenticationRedirect.Equals(input.AuthenticationRedirect))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AuthenticationRedirect != null)
                    hashCode = hashCode * 59 + this.AuthenticationRedirect.GetHashCode();
