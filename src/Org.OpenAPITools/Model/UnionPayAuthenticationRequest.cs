...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnionPayAuthenticationRequest")]
    ...
    public partial class UnionPayAuthenticationRequest : AuthenticationRequest, IEquatable<UnionPayAuthenticationRequest>, IValidatableObject
    {
        ...
        /// <param name="authenticationType">Indicates what kind of authentication scheme the merchant wants to use on the card. (required) (default to &quot;UnionPayAuthenticationRequest&quot;).</param>
        public UnionPayAuthenticationRequest(string smsPhoneNumber = default(string), string authenticationType = "UnionPayAuthenticationRequest") : base(authenticationType)
        {
            // to ensure "smsPhoneNumber" is required (not null)
            this.SmsPhoneNumber = smsPhoneNumber ?? throw new ArgumentNullException("smsPhoneNumber is a required property for UnionPayAuthenticationRequest and cannot be null");
        }
        ...
        [DataMember(Name = "smsPhoneNumber", IsRequired = true, EmitDefaultValue = false)]
