...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UnionPayAuthenticationRequest : Authentication,  IEquatable<UnionPayAuthenticationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UnionPayAuthenticationRequest(string smsPhoneNumber = default(string), string requestType = default(string)) : base(requestType)
        {
