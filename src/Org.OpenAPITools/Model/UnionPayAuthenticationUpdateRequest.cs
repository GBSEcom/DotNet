...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnionPayAuthenticationUpdateRequest")]
    ...
    public partial class UnionPayAuthenticationUpdateRequest : AuthenticationUpdateRequest, IEquatable<UnionPayAuthenticationUpdateRequest>, IValidatableObject
    {
        ...
        /// <param name="authenticationType">Object name of the authentication update request. (required) (default to &quot;UnionPayAuthenticationUpdateRequest&quot;).</param>
        /// <param name="billingAddress">billingAddress.</param>
        public UnionPayAuthenticationUpdateRequest(string smsVerificationCode = default(string), string securityCode = default(string), string storeId = default(string), string authenticationType = "UnionPayAuthenticationUpdateRequest", Address billingAddress = default(Address)) : base(storeId, authenticationType, billingAddress)
        {
