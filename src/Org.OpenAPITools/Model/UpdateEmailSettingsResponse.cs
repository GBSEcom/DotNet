...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UpdateEmailSettingsResponse : IEquatable<UpdateEmailSettingsResponse>, IValidatableObject
    {
        ...
        public UpdateEmailSettingsResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = null, List<StoreEmailSettingsResult> stores = default(List<StoreEmailSettingsResult>))
        {
