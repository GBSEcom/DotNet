...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateEmailSettingsResponse : IEquatable<UpdateEmailSettingsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEmailSettingsResponse" /> class.
        /// </summary>
        ...
        public UpdateEmailSettingsResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType responseType = default(ResponseType), List<StoreEmailSettingsResult> stores = default(List<StoreEmailSettingsResult>))
        {
        ...
        {
            return this.Equals(input as UpdateEmailSettingsResponse);
        }

        /// <summary>
        /// Returns true if UpdateEmailSettingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEmailSettingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEmailSettingsResponse input)
        {
            if (input == null)
                return false;
