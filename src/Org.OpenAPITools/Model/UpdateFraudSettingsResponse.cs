...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UpdateFraudSettingsResponse : IEquatable<UpdateFraudSettingsResponse>, IValidatableObject
    {
        ...
        public UpdateFraudSettingsResponse(string clientRequestId = default(string), string apiTraceId = default(string), ResponseType? responseType = null, List<StoreFraudSettingsResult> stores = default(List<StoreFraudSettingsResult>))
        {
