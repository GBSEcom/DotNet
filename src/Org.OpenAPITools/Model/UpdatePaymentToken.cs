...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UpdatePaymentToken :  IEquatable<UpdatePaymentToken>, IValidatableObject
    {
        ...
        public UpdatePaymentToken(string value = default(string), bool reusable = true, bool declineDuplicates = false, PaymentCard paymentCard = default(PaymentCard))
        {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for UpdatePaymentToken and cannot be null");
            }
            else
            {
                this.Value = value;
            ...
            if (paymentCard == null)
            {
                throw new InvalidDataException("paymentCard is a required property for UpdatePaymentToken and cannot be null");
            }
            else
            {
            ...
            if (declineDuplicates == null)
            {
                this.DeclineDuplicates = false;
            }
            else
            {
