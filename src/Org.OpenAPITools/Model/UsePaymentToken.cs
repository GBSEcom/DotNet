...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UsePaymentToken : IEquatable<UsePaymentToken>, IValidatableObject
    {
        ...
        public UsePaymentToken(string value = default(string), string tokenOriginStoreId = default(string), CardFunction? function = null, string securityCode = default(string), Expiration expiryDate = default(Expiration))
        {
