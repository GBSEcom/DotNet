...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Verification3ds :  IEquatable<Verification3ds>, IValidatableObject
    {
        ...
        public Verification3ds(string code = default(string), string status = default(string), string scheme = default(string))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for Verification3ds and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (scheme == null)
            {
                throw new InvalidDataException("scheme is a required property for Verification3ds and cannot be null");
            }
            else
            {
                this.Scheme = scheme;
