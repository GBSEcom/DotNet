...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VerificationAvs :  IEquatable<VerificationAvs>, IValidatableObject
    {
        ...
        public VerificationAvs(string code = default(string), string status = default(string), string scheme = default(string))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for VerificationAvs and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (scheme == null)
            {
                throw new InvalidDataException("scheme is a required property for VerificationAvs and cannot be null");
            }
            else
            {
                this.Scheme = scheme;
