...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VerificationCvv")]
    public partial class VerificationCvv : IEquatable<VerificationCvv>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VerificationCvv" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VerificationCvv() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VerificationCvv" /> class.
        /// </summary>
        ...
        public VerificationCvv(string code = default(string), string status = default(string), string scheme = default(string))
        {
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for VerificationCvv and cannot be null");
            // to ensure "scheme" is required (not null)
            this.Scheme = scheme ?? throw new ArgumentNullException("scheme is a required property for VerificationCvv and cannot be null");
            this.Status = status;
        }
        ...
        {
            return this.Equals(input as VerificationCvv);
        }

        /// <summary>
        /// Returns true if VerificationCvv instances are equal
        /// </summary>
        /// <param name="input">Instance of VerificationCvv to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VerificationCvv input)
        {
            if (input == null)
                return false;
