...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VerificationCvv :  IEquatable<VerificationCvv>, IValidatableObject
    {
        ...
        public VerificationCvv(string code = default(string), string status = default(string), string scheme = default(string))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for VerificationCvv and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (scheme == null)
            {
                throw new InvalidDataException("scheme is a required property for VerificationCvv and cannot be null");
            }
            else
            {
                this.Scheme = scheme;
