...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VoidPreAuthTransactions")]
    ...
    public partial class VoidPreAuthTransactions : SecondaryTransaction, IEquatable<VoidPreAuthTransactions>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="VoidPreAuthTransactions" /> class.
        /// </summary>
        /// <param name="requestType">Object name of the secondary transaction request. (required) (default to &quot;VoidPreAuthTransactions&quot;).</param>
        ...
        public VoidPreAuthTransactions(string requestType = "VoidPreAuthTransactions", string storeId = default(string), string merchantTransactionId = default(string), string comments = default(string), Order order = default(Order)) : base(requestType, storeId, merchantTransactionId, comments, order)
        {
        }
