...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VoidTransaction : SecondaryTransaction, IEquatable<VoidTransaction>, IValidatableObject
    {
        ...
        public VoidTransaction(Amount transactionAmount = default(Amount), string requestType = default(string), string storeId = default(string), string merchantTransactionId = default(string), string comments = default(string), Order order = default(Order)) : base(requestType, storeId, merchantTransactionId, comments, order)
        {
