...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VoidTransaction : SecondaryTransaction,  IEquatable<VoidTransaction>, IValidatableObject
    {
        ...
        public VoidTransaction(string requestType = default(string), string storeId = default(string), string comments = default(string), Order order = default(Order)) : base(requestType, storeId, comments, order)
        {
        }
