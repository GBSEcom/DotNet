...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WalletPaymentMethod :  IEquatable<WalletPaymentMethod>, IValidatableObject
    {
        ...
        public WalletPaymentMethod(string walletType = default(string))
        {
            ...
            if (walletType == null)
            {
                throw new InvalidDataException("walletType is a required property for WalletPaymentMethod and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="walletType", EmitDefaultValue=true)]
