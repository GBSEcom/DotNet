...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WalletPreAuthTransaction : PrimaryTransaction,  IEquatable<WalletPreAuthTransaction>, IValidatableObject
    {
        ...
        public WalletPreAuthTransaction(WalletPaymentMethod walletPaymentMethod = default(WalletPaymentMethod), SplitShipment splitShipment = default(SplitShipment), PaymentFacilitator paymentFacilitator = default(PaymentFacilitator), string requestType = default(string), Amount transactionAmount = default(Amount), string storeId = default(string), string merchantTransactionId = default(string), TransactionOrigin transactionOrigin = default(TransactionOrigin), Order order = default(Order)) : base(requestType, transactionAmount, storeId, merchantTransactionId, transactionOrigin, order)
        {
            // to ensure "walletPaymentMethod" is required (not null)
            if (walletPaymentMethod == null)
            {
                throw new InvalidDataException("walletPaymentMethod is a required property for WalletPreAuthTransaction and cannot be null");
            }
            else
            {
