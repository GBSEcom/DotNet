...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WalletSaleTransaction : PrimaryTransaction,  IEquatable<WalletSaleTransaction>, IValidatableObject
    {
        ...
        public WalletSaleTransaction(WalletPaymentMethod walletPaymentMethod = default(WalletPaymentMethod), PaymentFacilitator paymentFacilitator = default(PaymentFacilitator), string requestType = default(string), Amount transactionAmount = default(Amount), string storeId = default(string), string merchantTransactionId = default(string), TransactionOrigin? transactionOrigin = default(TransactionOrigin?), Order order = default(Order)) : base(requestType, transactionAmount, storeId, merchantTransactionId, transactionOrigin, order)
        {
            // to ensure "walletPaymentMethod" is required (not null)
            if (walletPaymentMethod == null)
            {
                throw new InvalidDataException("walletPaymentMethod is a required property for WalletSaleTransaction and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="walletPaymentMethod", EmitDefaultValue=true)]
