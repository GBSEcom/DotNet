...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WalletSaleTransactionAllOf :  IEquatable<WalletSaleTransactionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletSaleTransactionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WalletSaleTransactionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletSaleTransactionAllOf" /> class.
        /// </summary>
        ...
        public WalletSaleTransactionAllOf(WalletPaymentMethod walletPaymentMethod = default(WalletPaymentMethod), PaymentFacilitator paymentFacilitator = default(PaymentFacilitator))
        {
            ...
            {
                throw new InvalidDataException("walletPaymentMethod is a required property for WalletSaleTransactionAllOf and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as WalletSaleTransactionAllOf);
        }

        /// <summary>
        /// Returns true if WalletSaleTransactionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletSaleTransactionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletSaleTransactionAllOf input)
        {
            if (input == null)
                return false;
